...
const FATE_DILEMMAS_UNIQUE_100 = [{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что тебе важнее всего сохранить в отношениях с родными Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What matters most to you in your relationships with family What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué es lo más importante para ti conservar en la relación con tu familia ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que é mais importante para você preservar na relação com a família O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was ist dir in der Beziehung zu deiner Familie am wichtigsten zu bewahren Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Qu’est-ce qui compte le plus pour toi dans ta relation avec ta famille Que feras-tu dans cette situation ?"},"a":{"ru":"Сразу поддержу близкого и помогу делом.","en":"I’ll support my loved one immediately and help in a practical way.","es":"Apoyaré de inmediato a la persona cercana y ayudaré de forma práctica.","pt":"Vou apoiar de imediato a pessoa próxima e ajudar de forma prática.","de":"Ich unterstütze die nahestehende Person sofort und helfe konkret.","fr":"Je soutiendrai immédiatement mon proche et l’aiderai concrètement."},"b":{"ru":"Сначала выслушаю и постараюсь понять его сторону.","en":"I’ll listen first and try to understand their side.","es":"Primero escucharé e intentaré entender su punto de vista.","pt":"Primeiro vou ouvir e tentar compreender o lado da pessoa.","de":"Ich höre zuerst zu und versuche, ihre Seite zu verstehen.","fr":"J’écouterai d’abord et essaierai de comprendre son point de vue."},"c":{"ru":"Дам немного времени, а затем сам вернусь к разговору.","en":"I’ll give it some time, then come back to the conversation myself.","es":"Daré algo de tiempo y luego volveré a hablar por mi cuenta.","pt":"Vou dar algum tempo e depois retomarei a conversa.","de":"Ich lasse etwas Zeit vergehen und komme dann selbst auf das Gespräch zurück.","fr":"Je laisserai passer un peu de temps, puis je reviendrai moi-même à la conversation."},"stats":{"a":36,"b":24,"c":40},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой семейный обычай ты бы оставил детям Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which family tradition would you pass on to your children What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué tradición familiar transmitirías a tus hijos ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que tradição familiar você passaria para os seus filhos O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welche Familientradition würdest du deinen Kindern weitergeben Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quelle tradition familiale transmettrais-tu à tes enfants Que feras-tu dans cette situation ?"},"a":{"ru":"Сразу поддержу близкого и помогу делом.","en":"I’ll support my loved one immediately and help in a practical way.","es":"Apoyaré de inmediato a la persona cercana y ayudaré de forma práctica.","pt":"Vou apoiar de imediato a pessoa próxima e ajudar de forma prática.","de":"Ich unterstütze die nahestehende Person sofort und helfe konkret.","fr":"Je soutiendrai immédiatement mon proche et l’aiderai concrètement."},"b":{"ru":"Сначала выслушаю и постараюсь понять его сторону.","en":"I’ll listen first and try to understand their side.","es":"Primero escucharé e intentaré entender su punto de vista.","pt":"Primeiro vou ouvir e tentar compreender o lado da pessoa.","de":"Ich höre zuerst zu und versuche, ihre Seite zu verstehen.","fr":"J’écouterai d’abord et essaierai de comprendre son point de vue."},"c":{"ru":"Дам немного времени, а затем сам вернусь к разговору.","en":"I’ll give it some time, then come back to the conversation myself.","es":"Daré algo de tiempo y luego volveré a hablar por mi cuenta.","pt":"Vou dar algum tempo e depois retomarei a conversa.","de":"Ich lasse etwas Zeit vergehen und komme dann selbst auf das Gespräch zurück.","fr":"Je laisserai passer un peu de temps, puis je reviendrai moi-même à la conversation."},"stats":{"a":43,"b":35,"c":22},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что ты предпочитаешь делать во время большого семейного праздника Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What do you prefer to do during a big family celebration What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué prefieres hacer durante una gran celebración familiar ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que você prefere fazer durante uma grande celebração familiar O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was machst du bei einem großen Familienfest am liebsten Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Que préfères-tu faire lors d’une grande fête de famille Que feras-tu dans cette situation ?"},"a":{"ru":"Сразу поддержу близкого и помогу делом.","en":"I’ll support my loved one immediately and help in a practical way.","es":"Apoyaré de inmediato a la persona cercana y ayudaré de forma práctica.","pt":"Vou apoiar de imediato a pessoa próxima e ajudar de forma prática.","de":"Ich unterstütze die nahestehende Person sofort und helfe konkret.","fr":"Je soutiendrai immédiatement mon proche et l’aiderai concrètement."},"b":{"ru":"Сначала выслушаю и постараюсь понять его сторону.","en":"I’ll listen first and try to understand their side.","es":"Primero escucharé e intentaré entender su punto de vista.","pt":"Primeiro vou ouvir e tentar compreender o lado da pessoa.","de":"Ich höre zuerst zu und versuche, ihre Seite zu verstehen.","fr":"J’écouterai d’abord et essaierai de comprendre son point de vue."},"c":{"ru":"Дам немного времени, а затем сам вернусь к разговору.","en":"I’ll give it some time, then come back to the conversation myself.","es":"Daré algo de tiempo y luego volveré a hablar por mi cuenta.","pt":"Vou dar algum tempo e depois retomarei a conversa.","de":"Ich lasse etwas Zeit vergehen und komme dann selbst auf das Gespräch zurück.","fr":"Je laisserai passer un peu de temps, puis je reviendrai moi-même à la conversation."},"stats":{"a":44,"b":46,"c":10},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Как ты обычно показываешь близким, что ценишь их Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. How do you usually show your loved ones that you value them What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Cómo sueles demostrar a tus seres queridos que los valoras ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Como você costuma mostrar aos seus entes queridos que os valoriza O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Wie zeigst du deinen Angehörigen normalerweise, dass du sie schätzt Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Comment montres-tu habituellement à tes proches que tu les apprécies Que feras-tu dans cette situation ?"},"a":{"ru":"Сразу поддержу близкого и помогу делом.","en":"I’ll support my loved one immediately and help in a practical way.","es":"Apoyaré de inmediato a la persona cercana y ayudaré de forma práctica.","pt":"Vou apoiar de imediato a pessoa próxima e ajudar de forma prática.","de":"Ich unterstütze die nahestehende Person sofort und helfe konkret.","fr":"Je soutiendrai immédiatement mon proche et l’aiderai concrètement."},"b":{"ru":"Сначала выслушаю и постараюсь понять его сторону.","en":"I’ll listen first and try to understand their side.","es":"Primero escucharé e intentaré entender su punto de vista.","pt":"Primeiro vou ouvir e tentar compreender o lado da pessoa.","de":"Ich höre zuerst zu und versuche, ihre Seite zu verstehen.","fr":"J’écouterai d’abord et essaierai de comprendre son point de vue."},"c":{"ru":"Дам немного времени, а затем сам вернусь к разговору.","en":"I’ll give it some time, then come back to the conversation myself.","es":"Daré algo de tiempo y luego volveré a hablar por mi cuenta.","pt":"Vou dar algum tempo e depois retomarei a conversa.","de":"Ich lasse etwas Zeit vergehen und komme dann selbst auf das Gespräch zurück.","fr":"Je laisserai passer un peu de temps, puis je reviendrai moi-même à la conversation."},"stats":{"a":51,"b":32,"c":17},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой совет от старших ты считаешь самым полезным Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which piece of advice from older people do you find most useful What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué consejo de las personas mayores consideras más útil ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que conselho das pessoas mais velhas você considera mais útil O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welchen Rat von älteren Menschen findest du am hilfreichsten Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel conseil des personnes plus âgées te semble le plus utile Que feras-tu dans cette situation ?"},"a":{"ru":"Сразу поддержу близкого и помогу делом.","en":"I’ll support my loved one immediately and help in a practical way.","es":"Apoyaré de inmediato a la persona cercana y ayudaré de forma práctica.","pt":"Vou apoiar de imediato a pessoa próxima e ajudar de forma prática.","de":"Ich unterstütze die nahestehende Person sofort und helfe konkret.","fr":"Je soutiendrai immédiatement mon proche et l’aiderai concrètement."},"b":{"ru":"Сначала выслушаю и постараюсь понять его сторону.","en":"I’ll listen first and try to understand their side.","es":"Primero escucharé e intentaré entender su punto de vista.","pt":"Primeiro vou ouvir e tentar compreender o lado da pessoa.","de":"Ich höre zuerst zu und versuche, ihre Seite zu verstehen.","fr":"J’écouterai d’abord et essaierai de comprendre son point de vue."},"c":{"ru":"Дам немного времени, а затем сам вернусь к разговору.","en":"I’ll give it some time, then come back to the conversation myself.","es":"Daré algo de tiempo y luego volveré a hablar por mi cuenta.","pt":"Vou dar algum tempo e depois retomarei a conversa.","de":"Ich lasse etwas Zeit vergehen und komme dann selbst auf das Gespräch zurück.","fr":"Je laisserai passer un peu de temps, puis je reviendrai moi-même à la conversation."},"stats":{"a":37,"b":43,"c":20},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что делает человека настоящим другом в твоих глазах Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What makes someone a true friend in your eyes What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué convierte a alguien en un verdadero amigo para ti ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que torna alguém um verdadeiro amigo aos seus olhos O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was macht für dich einen echten Freund aus Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Qu’est-ce qui fait d’une personne un véritable ami à tes yeux Que feras-tu dans cette situation ?"},"a":{"ru":"Сразу поддержу близкого и помогу делом.","en":"I’ll support my loved one immediately and help in a practical way.","es":"Apoyaré de inmediato a la persona cercana y ayudaré de forma práctica.","pt":"Vou apoiar de imediato a pessoa próxima e ajudar de forma prática.","de":"Ich unterstütze die nahestehende Person sofort und helfe konkret.","fr":"Je soutiendrai immédiatement mon proche et l’aiderai concrètement."},"b":{"ru":"Сначала выслушаю и постараюсь понять его сторону.","en":"I’ll listen first and try to understand their side.","es":"Primero escucharé e intentaré entender su punto de vista.","pt":"Primeiro vou ouvir e tentar compreender o lado da pessoa.","de":"Ich höre zuerst zu und versuche, ihre Seite zu verstehen.","fr":"J’écouterai d’abord et essaierai de comprendre son point de vue."},"c":{"ru":"Дам немного времени, а затем сам вернусь к разговору.","en":"I’ll give it some time, then come back to the conversation myself.","es":"Daré algo de tiempo y luego volveré a hablar por mi cuenta.","pt":"Vou dar algum tempo e depois retomarei a conversa.","de":"Ich lasse etwas Zeit vergehen und komme dann selbst auf das Gespräch zurück.","fr":"Je laisserai passer un peu de temps, puis je reviendrai moi-même à la conversation."},"stats":{"a":44,"b":29,"c":27},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что тебе проще простить близкому другу Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What is easiest for you to forgive a close friend for What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué te resulta más fácil perdonar a un amigo cercano ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que é mais fácil para você perdoar a um amigo próximo O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was kannst du einem engen Freund am ehesten verzeihen Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Qu’est-ce que tu pardonnes le plus facilement à un ami proche Que feras-tu dans cette situation ?"},"a":{"ru":"Сразу поддержу близкого и помогу делом.","en":"I’ll support my loved one immediately and help in a practical way.","es":"Apoyaré de inmediato a la persona cercana y ayudaré de forma práctica.","pt":"Vou apoiar de imediato a pessoa próxima e ajudar de forma prática.","de":"Ich unterstütze die nahestehende Person sofort und helfe konkret.","fr":"Je soutiendrai immédiatement mon proche et l’aiderai concrètement."},"b":{"ru":"Сначала выслушаю и постараюсь понять его сторону.","en":"I’ll listen first and try to understand their side.","es":"Primero escucharé e intentaré entender su punto de vista.","pt":"Primeiro vou ouvir e tentar compreender o lado da pessoa.","de":"Ich höre zuerst zu und versuche, ihre Seite zu verstehen.","fr":"J’écouterai d’abord et essaierai de comprendre son point de vue."},"c":{"ru":"Дам немного времени, а затем сам вернусь к разговору.","en":"I’ll give it some time, then come back to the conversation myself.","es":"Daré algo de tiempo y luego volveré a hablar por mi cuenta.","pt":"Vou dar algum tempo e depois retomarei a conversa.","de":"Ich lasse etwas Zeit vergehen und komme dann selbst auf das Gespräch zurück.","fr":"Je laisserai passer un peu de temps, puis je reviendrai moi-même à la conversation."},"stats":{"a":45,"b":40,"c":15},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Как ты выбираешь человека для совместной поездки Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. How do you choose someone to travel with What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Cómo eliges a una persona para viajar juntos ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Como você escolhe alguém para viajar junto O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Wie wählst du jemanden für eine gemeinsame Reise aus Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Comment choisis-tu quelqu’un pour voyager avec toi Que feras-tu dans cette situation ?"},"a":{"ru":"Сразу поддержу близкого и помогу делом.","en":"I’ll support my loved one immediately and help in a practical way.","es":"Apoyaré de inmediato a la persona cercana y ayudaré de forma práctica.","pt":"Vou apoiar de imediato a pessoa próxima e ajudar de forma prática.","de":"Ich unterstütze die nahestehende Person sofort und helfe konkret.","fr":"Je soutiendrai immédiatement mon proche et l’aiderai concrètement."},"b":{"ru":"Сначала выслушаю и постараюсь понять его сторону.","en":"I’ll listen first and try to understand their side.","es":"Primero escucharé e intentaré entender su punto de vista.","pt":"Primeiro vou ouvir e tentar compreender o lado da pessoa.","de":"Ich höre zuerst zu und versuche, ihre Seite zu verstehen.","fr":"J’écouterai d’abord et essaierai de comprendre son point de vue."},"c":{"ru":"Дам немного времени, а затем сам вернусь к разговору.","en":"I’ll give it some time, then come back to the conversation myself.","es":"Daré algo de tiempo y luego volveré a hablar por mi cuenta.","pt":"Vou dar algum tempo e depois retomarei a conversa.","de":"Ich lasse etwas Zeit vergehen und komme dann selbst auf das Gespräch zurück.","fr":"Je laisserai passer un peu de temps, puis je reviendrai moi-même à la conversation."},"stats":{"a":58,"b":26,"c":16},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что ты предпочитаешь делать, когда друг долго молчит Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What do you prefer to do when a friend stays silent for a long time What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué prefieres hacer cuando un amigo guarda silencio durante mucho tiempo ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que você prefere fazer quando um amigo fica em silêncio por muito tempo O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was machst du lieber, wenn ein Freund lange schweigt Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Que préfères-tu faire lorsqu’un ami reste longtemps silencieux Que feras-tu dans cette situation ?"},"a":{"ru":"Сразу поддержу близкого и помогу делом.","en":"I’ll support my loved one immediately and help in a practical way.","es":"Apoyaré de inmediato a la persona cercana y ayudaré de forma práctica.","pt":"Vou apoiar de imediato a pessoa próxima e ajudar de forma prática.","de":"Ich unterstütze die nahestehende Person sofort und helfe konkret.","fr":"Je soutiendrai immédiatement mon proche et l’aiderai concrètement."},"b":{"ru":"Сначала выслушаю и постараюсь понять его сторону.","en":"I’ll listen first and try to understand their side.","es":"Primero escucharé e intentaré entender su punto de vista.","pt":"Primeiro vou ouvir e tentar compreender o lado da pessoa.","de":"Ich höre zuerst zu und versuche, ihre Seite zu verstehen.","fr":"J’écouterai d’abord et essaierai de comprendre son point de vue."},"c":{"ru":"Дам немного времени, а затем сам вернусь к разговору.","en":"I’ll give it some time, then come back to the conversation myself.","es":"Daré algo de tiempo y luego volveré a hablar por mi cuenta.","pt":"Vou dar algum tempo e depois retomarei a conversa.","de":"Ich lasse etwas Zeit vergehen und komme dann selbst auf das Gespräch zurück.","fr":"Je laisserai passer un peu de temps, puis je reviendrai moi-même à la conversation."},"stats":{"a":38,"b":37,"c":25},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Как ты относишься к дружбе, которая началась случайно Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. How do you feel about friendships that begin by chance What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Cómo ves las amistades que comienzan por casualidad ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Como você vê amizades que começam por acaso O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Wie stehst du zu Freundschaften, die zufällig beginnen Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Que penses-tu des amitiés qui commencent par hasard Que feras-tu dans cette situation ?"},"a":{"ru":"Сразу поддержу близкого и помогу делом.","en":"I’ll support my loved one immediately and help in a practical way.","es":"Apoyaré de inmediato a la persona cercana y ayudaré de forma práctica.","pt":"Vou apoiar de imediato a pessoa próxima e ajudar de forma prática.","de":"Ich unterstütze die nahestehende Person sofort und helfe konkret.","fr":"Je soutiendrai immédiatement mon proche et l’aiderai concrètement."},"b":{"ru":"Сначала выслушаю и постараюсь понять его сторону.","en":"I’ll listen first and try to understand their side.","es":"Primero escucharé e intentaré entender su punto de vista.","pt":"Primeiro vou ouvir e tentar compreender o lado da pessoa.","de":"Ich höre zuerst zu und versuche, ihre Seite zu verstehen.","fr":"J’écouterai d’abord et essaierai de comprendre son point de vue."},"c":{"ru":"Дам немного времени, а затем сам вернусь к разговору.","en":"I’ll give it some time, then come back to the conversation myself.","es":"Daré algo de tiempo y luego volveré a hablar por mi cuenta.","pt":"Vou dar algum tempo e depois retomarei a conversa.","de":"Ich lasse etwas Zeit vergehen und komme dann selbst auf das Gespräch zurück.","fr":"Je laisserai passer un peu de temps, puis je reviendrai moi-même à la conversation."},"stats":{"a":39,"b":48,"c":13},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что для тебя важнее в хорошем рабочем дне Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What matters most to you on a good workday What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué es lo más importante para ti en un buen día de trabajo ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que é mais importante para você em um bom dia de trabalho O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was ist dir an einem guten Arbeitstag am wichtigsten Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Qu’est-ce qui compte le plus pour toi lors d’une bonne journée de travail Que feras-tu dans cette situation ?"},"a":{"ru":"Возьму задачу под контроль и доведу её до конца.","en":"I’ll take control of the task and finish it.","es":"Tomaré el control de la tarea y la terminaré.","pt":"Vou assumir o controlo da tarefa e concluí-la.","de":"Ich übernehme die Aufgabe und bringe sie zu Ende.","fr":"Je prendrai la tâche en main et l’achèverai."},"b":{"ru":"Сначала составлю план и проверю несколько вариантов.","en":"I’ll make a plan first and compare several options.","es":"Primero haré un plan y compararé varias opciones.","pt":"Primeiro farei um plano e compararei várias opções.","de":"Ich erstelle zuerst einen Plan und prüfe mehrere Möglichkeiten.","fr":"Je ferai d’abord un plan et comparerai plusieurs options."},"c":{"ru":"Проконсультируюсь с тем, кто уже сталкивался с таким.","en":"I’ll consult someone who has dealt with this before.","es":"Consultaré a alguien que ya se haya enfrentado a algo parecido.","pt":"Vou consultar alguém que já passou por algo assim.","de":"Ich frage jemanden um Rat, der damit schon Erfahrung hat.","fr":"Je demanderai conseil à quelqu’un qui a déjà connu cela."},"stats":{"a":52,"b":34,"c":14},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой способ организации дел тебе ближе Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which way of organizing your tasks suits you best What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué forma de organizar tus tareas prefieres ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que forma de organizar suas tarefas combina mais com você O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welche Art, deine Aufgaben zu organisieren, liegt dir am besten Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quelle méthode d’organisation de tes tâches te convient le mieux Que feras-tu dans cette situation ?"},"a":{"ru":"Возьму задачу под контроль и доведу её до конца.","en":"I’ll take control of the task and finish it.","es":"Tomaré el control de la tarea y la terminaré.","pt":"Vou assumir o controlo da tarefa e concluí-la.","de":"Ich übernehme die Aufgabe und bringe sie zu Ende.","fr":"Je prendrai la tâche en main et l’achèverai."},"b":{"ru":"Сначала составлю план и проверю несколько вариантов.","en":"I’ll make a plan first and compare several options.","es":"Primero haré un plan y compararé varias opciones.","pt":"Primeiro farei um plano e compararei várias opções.","de":"Ich erstelle zuerst einen Plan und prüfe mehrere Möglichkeiten.","fr":"Je ferai d’abord un plan et comparerai plusieurs options."},"c":{"ru":"Проконсультируюсь с тем, кто уже сталкивался с таким.","en":"I’ll consult someone who has dealt with this before.","es":"Consultaré a alguien que ya se haya enfrentado a algo parecido.","pt":"Vou consultar alguém que já passou por algo assim.","de":"Ich frage jemanden um Rat, der damit schon Erfahrung hat.","fr":"Je demanderai conseil à quelqu’un qui a déjà connu cela."},"stats":{"a":53,"b":45,"c":2},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что сильнее мотивирует тебя закончить сложную задачу Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What motivates you most to finish a difficult task What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué te motiva más a terminar una tarea difícil ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que mais motiva você a terminar uma tarefa difícil O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was motiviert dich am stärksten, eine schwierige Aufgabe zu beenden Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Qu’est-ce qui te motive le plus à terminer une tâche difficile Que feras-tu dans cette situation ?"},"a":{"ru":"Возьму задачу под контроль и доведу её до конца.","en":"I’ll take control of the task and finish it.","es":"Tomaré el control de la tarea y la terminaré.","pt":"Vou assumir o controlo da tarefa e concluí-la.","de":"Ich übernehme die Aufgabe und bringe sie zu Ende.","fr":"Je prendrai la tâche en main et l’achèverai."},"b":{"ru":"Сначала составлю план и проверю несколько вариантов.","en":"I’ll make a plan first and compare several options.","es":"Primero haré un plan y compararé varias opciones.","pt":"Primeiro farei um plano e compararei várias opções.","de":"Ich erstelle zuerst einen Plan und prüfe mehrere Möglichkeiten.","fr":"Je ferai d’abord un plan et comparerai plusieurs options."},"c":{"ru":"Проконсультируюсь с тем, кто уже сталкивался с таким.","en":"I’ll consult someone who has dealt with this before.","es":"Consultaré a alguien que ya se haya enfrentado a algo parecido.","pt":"Vou consultar alguém que já passou por algo assim.","de":"Ich frage jemanden um Rat, der damit schon Erfahrung hat.","fr":"Je demanderai conseil à quelqu’un qui a déjà connu cela."},"stats":{"a":39,"b":31,"c":30},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что ты ценишь в руководителе больше всего Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What do you value most in a manager What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué valoras más en un jefe ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que você mais valoriza em um chefe O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was schätzt du an einer Führungskraft am meisten Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Qu’apprécies-tu le plus chez un responsable Que feras-tu dans cette situation ?"},"a":{"ru":"Возьму задачу под контроль и доведу её до конца.","en":"I’ll take control of the task and finish it.","es":"Tomaré el control de la tarea y la terminaré.","pt":"Vou assumir o controlo da tarefa e concluí-la.","de":"Ich übernehme die Aufgabe und bringe sie zu Ende.","fr":"Je prendrai la tâche en main et l’achèverai."},"b":{"ru":"Сначала составлю план и проверю несколько вариантов.","en":"I’ll make a plan first and compare several options.","es":"Primero haré un plan y compararé varias opciones.","pt":"Primeiro farei um plano e compararei várias opções.","de":"Ich erstelle zuerst einen Plan und prüfe mehrere Möglichkeiten.","fr":"Je ferai d’abord un plan et comparerai plusieurs options."},"c":{"ru":"Проконсультируюсь с тем, кто уже сталкивался с таким.","en":"I’ll consult someone who has dealt with this before.","es":"Consultaré a alguien que ya se haya enfrentado a algo parecido.","pt":"Vou consultar alguém que já passou por algo assim.","de":"Ich frage jemanden um Rat, der damit schon Erfahrung hat.","fr":"Je demanderai conseil à quelqu’un qui a déjà connu cela."},"stats":{"a":46,"b":42,"c":12},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Как ты выбираешь между интересной работой и удобным графиком Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. How do you choose between an interesting job and a convenient schedule What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Cómo eliges entre un trabajo interesante y un horario cómodo ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Como você escolhe entre um trabalho interessante e um horário confortável O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Wie entscheidest du zwischen einer interessanten Arbeit und einem bequemen Zeitplan Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Comment choisis-tu entre un travail intéressant et un emploi du temps confortable Que feras-tu dans cette situation ?"},"a":{"ru":"Возьму задачу под контроль и доведу её до конца.","en":"I’ll take control of the task and finish it.","es":"Tomaré el control de la tarea y la terminaré.","pt":"Vou assumir o controlo da tarefa e concluí-la.","de":"Ich übernehme die Aufgabe und bringe sie zu Ende.","fr":"Je prendrai la tâche en main et l’achèverai."},"b":{"ru":"Сначала составлю план и проверю несколько вариантов.","en":"I’ll make a plan first and compare several options.","es":"Primero haré un plan y compararé varias opciones.","pt":"Primeiro farei um plano e compararei várias opções.","de":"Ich erstelle zuerst einen Plan und prüfe mehrere Möglichkeiten.","fr":"Je ferai d’abord un plan et comparerai plusieurs options."},"c":{"ru":"Проконсультируюсь с тем, кто уже сталкивался с таким.","en":"I’ll consult someone who has dealt with this before.","es":"Consultaré a alguien que ya se haya enfrentado a algo parecido.","pt":"Vou consultar alguém que já passou por algo assim.","de":"Ich frage jemanden um Rat, der damit schon Erfahrung hat.","fr":"Je demanderai conseil à quelqu’un qui a déjà connu cela."},"stats":{"a":53,"b":28,"c":19},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. На что тебе приятнее потратить неожиданную небольшую сумму Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What would you rather spend an unexpected small amount of money on What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿En qué gastarías una pequeña cantidad de dinero inesperada ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Em que gastaria uma pequena quantia inesperada O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Wofür würdest du eine unerwartete kleine Geldsumme lieber ausgeben Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. À quoi dépenserais-tu de préférence une petite somme reçue par surprise Que feras-tu dans cette situation ?"},"a":{"ru":"Возьму задачу под контроль и доведу её до конца.","en":"I’ll take control of the task and finish it.","es":"Tomaré el control de la tarea y la terminaré.","pt":"Vou assumir o controlo da tarefa e concluí-la.","de":"Ich übernehme die Aufgabe und bringe sie zu Ende.","fr":"Je prendrai la tâche en main et l’achèverai."},"b":{"ru":"Сначала составлю план и проверю несколько вариантов.","en":"I’ll make a plan first and compare several options.","es":"Primero haré un plan y compararé varias opciones.","pt":"Primeiro farei um plano e compararei várias opções.","de":"Ich erstelle zuerst einen Plan und prüfe mehrere Möglichkeiten.","fr":"Je ferai d’abord un plan et comparerai plusieurs options."},"c":{"ru":"Проконсультируюсь с тем, кто уже сталкивался с таким.","en":"I’ll consult someone who has dealt with this before.","es":"Consultaré a alguien que ya se haya enfrentado a algo parecido.","pt":"Vou consultar alguém que já passou por algo assim.","de":"Ich frage jemanden um Rat, der damit schon Erfahrung hat.","fr":"Je demanderai conseil à quelqu’un qui a déjà connu cela."},"stats":{"a":54,"b":39,"c":7},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой способ накопления тебе ближе Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which saving method suits you best What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué método de ahorro prefieres ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Qual método de poupança combina mais com você O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welche Art zu sparen liegt dir am besten Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quelle méthode d’épargne te convient le mieux Que feras-tu dans cette situation ?"},"a":{"ru":"Возьму задачу под контроль и доведу её до конца.","en":"I’ll take control of the task and finish it.","es":"Tomaré el control de la tarea y la terminaré.","pt":"Vou assumir o controlo da tarefa e concluí-la.","de":"Ich übernehme die Aufgabe und bringe sie zu Ende.","fr":"Je prendrai la tâche en main et l’achèverai."},"b":{"ru":"Сначала составлю план и проверю несколько вариантов.","en":"I’ll make a plan first and compare several options.","es":"Primero haré un plan y compararé varias opciones.","pt":"Primeiro farei um plano e compararei várias opções.","de":"Ich erstelle zuerst einen Plan und prüfe mehrere Möglichkeiten.","fr":"Je ferai d’abord un plan et comparerai plusieurs options."},"c":{"ru":"Проконсультируюсь с тем, кто уже сталкивался с таким.","en":"I’ll consult someone who has dealt with this before.","es":"Consultaré a alguien que ya se haya enfrentado a algo parecido.","pt":"Vou consultar alguém que já passou por algo assim.","de":"Ich frage jemanden um Rat, der damit schon Erfahrung hat.","fr":"Je demanderai conseil à quelqu’un qui a déjà connu cela."},"stats":{"a":40,"b":25,"c":35},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что ты проверяешь перед крупной покупкой Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What do you check before making a major purchase What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué compruebas antes de una compra importante ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que você verifica antes de uma compra importante O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was prüfst du vor einem größeren Kauf Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Que vérifies-tu avant un achat important Que feras-tu dans cette situation ?"},"a":{"ru":"Возьму задачу под контроль и доведу её до конца.","en":"I’ll take control of the task and finish it.","es":"Tomaré el control de la tarea y la terminaré.","pt":"Vou assumir o controlo da tarefa e concluí-la.","de":"Ich übernehme die Aufgabe und bringe sie zu Ende.","fr":"Je prendrai la tâche en main et l’achèverai."},"b":{"ru":"Сначала составлю план и проверю несколько вариантов.","en":"I’ll make a plan first and compare several options.","es":"Primero haré un plan y compararé varias opciones.","pt":"Primeiro farei um plano e compararei várias opções.","de":"Ich erstelle zuerst einen Plan und prüfe mehrere Möglichkeiten.","fr":"Je ferai d’abord un plan et comparerai plusieurs options."},"c":{"ru":"Проконсультируюсь с тем, кто уже сталкивался с таким.","en":"I’ll consult someone who has dealt with this before.","es":"Consultaré a alguien que ya se haya enfrentado a algo parecido.","pt":"Vou consultar alguém que já passou por algo assim.","de":"Ich frage jemanden um Rat, der damit schon Erfahrung hat.","fr":"Je demanderai conseil à quelqu’un qui a déjà connu cela."},"stats":{"a":47,"b":36,"c":17},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что для тебя важнее при выборе дорогой вещи Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What matters most when choosing an expensive item What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué es lo más importante al elegir algo caro ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que é mais importante ao escolher algo caro O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was ist bei der Wahl eines teuren Gegenstands am wichtigsten Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Qu’est-ce qui compte le plus pour choisir un objet coûteux Que feras-tu dans cette situation ?"},"a":{"ru":"Возьму задачу под контроль и доведу её до конца.","en":"I’ll take control of the task and finish it.","es":"Tomaré el control de la tarea y la terminaré.","pt":"Vou assumir o controlo da tarefa e concluí-la.","de":"Ich übernehme die Aufgabe und bringe sie zu Ende.","fr":"Je prendrai la tâche en main et l’achèverai."},"b":{"ru":"Сначала составлю план и проверю несколько вариантов.","en":"I’ll make a plan first and compare several options.","es":"Primero haré un plan y compararé varias opciones.","pt":"Primeiro farei um plano e compararei várias opções.","de":"Ich erstelle zuerst einen Plan und prüfe mehrere Möglichkeiten.","fr":"Je ferai d’abord un plan et comparerai plusieurs options."},"c":{"ru":"Проконсультируюсь с тем, кто уже сталкивался с таким.","en":"I’ll consult someone who has dealt with this before.","es":"Consultaré a alguien que ya se haya enfrentado a algo parecido.","pt":"Vou consultar alguém que já passou por algo assim.","de":"Ich frage jemanden um Rat, der damit schon Erfahrung hat.","fr":"Je demanderai conseil à quelqu’un qui a déjà connu cela."},"stats":{"a":48,"b":47,"c":5},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Как ты относишься к покупкам, которые долго откладывал Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. How do you feel about purchases you have been postponing for a long time What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Cómo ves las compras que has pospuesto durante mucho tiempo ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Como você encara compras que adiou por muito tempo O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Wie gehst du mit Käufen um, die du lange aufgeschoben hast Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Que penses-tu des achats que tu repousses depuis longtemps Que feras-tu dans cette situation ?"},"a":{"ru":"Возьму задачу под контроль и доведу её до конца.","en":"I’ll take control of the task and finish it.","es":"Tomaré el control de la tarea y la terminaré.","pt":"Vou assumir o controlo da tarefa e concluí-la.","de":"Ich übernehme die Aufgabe und bringe sie zu Ende.","fr":"Je prendrai la tâche en main et l’achèverai."},"b":{"ru":"Сначала составлю план и проверю несколько вариантов.","en":"I’ll make a plan first and compare several options.","es":"Primero haré un plan y compararé varias opciones.","pt":"Primeiro farei um plano e compararei várias opções.","de":"Ich erstelle zuerst einen Plan und prüfe mehrere Möglichkeiten.","fr":"Je ferai d’abord un plan et comparerai plusieurs options."},"c":{"ru":"Проконсультируюсь с тем, кто уже сталкивался с таким.","en":"I’ll consult someone who has dealt with this before.","es":"Consultaré a alguien que ya se haya enfrentado a algo parecido.","pt":"Vou consultar alguém que já passou por algo assim.","de":"Ich frage jemanden um Rat, der damit schon Erfahrung hat.","fr":"Je demanderai conseil à quelqu’un qui a déjà connu cela."},"stats":{"a":55,"b":33,"c":12},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. На что ты хотел бы получать дополнительный час каждый день Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What would you like to gain an extra hour for every day What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Para qué te gustaría tener una hora extra cada día ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Para que gostaria de ter uma hora extra todos os dias O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Wofür hättest du gern jeden Tag eine zusätzliche Stunde Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. À quoi aimerais-tu consacrer une heure supplémentaire chaque jour Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу лучший вариант по цене и качеству и оформлю покупку.","en":"I’ll choose the best value for money and make the purchase.","es":"Elegiré la mejor relación calidad-precio y haré la compra.","pt":"Vou escolher a melhor relação qualidade-preço e fazer a compra.","de":"Ich wähle das beste Preis-Leistungs-Verhältnis und kaufe es.","fr":"Je choisirai le meilleur rapport qualité-prix et ferai l’achat."},"b":{"ru":"Сравню предложения, характеристики и отзывы перед оплатой.","en":"I’ll compare offers, specifications, and reviews before paying.","es":"Compararé ofertas, características y reseñas antes de pagar.","pt":"Vou comparar ofertas, características e avaliações antes de pagar.","de":"Ich vergleiche Angebote, Daten und Bewertungen vor dem Bezahlen.","fr":"Je comparerai les offres, caractéristiques et avis avant de payer."},"c":{"ru":"Отложу решение, чтобы убедиться, что покупка действительно нужна.","en":"I’ll postpone the decision to make sure I really need the purchase.","es":"Aplazaré la decisión para asegurarme de que realmente necesito comprarlo.","pt":"Vou adiar a decisão para ter a certeza de que a compra é realmente necessária.","de":"Ich verschiebe die Entscheidung, um sicherzugehen, dass ich den Kauf wirklich brauche.","fr":"Je reporterai la décision pour vérifier que cet achat est vraiment nécessaire."},"stats":{"a":41,"b":44,"c":15},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Как ты предпочитаешь проводить редкий полностью свободный день Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. How do you prefer to spend a rare completely free day What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Cómo prefieres pasar un raro día completamente libre ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Como prefere passar um raro dia totalmente livre O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Wie verbringst du einen seltenen, völlig freien Tag am liebsten Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Comment préfères-tu passer une rare journée totalement libre Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу лучший вариант по цене и качеству и оформлю покупку.","en":"I’ll choose the best value for money and make the purchase.","es":"Elegiré la mejor relación calidad-precio y haré la compra.","pt":"Vou escolher a melhor relação qualidade-preço e fazer a compra.","de":"Ich wähle das beste Preis-Leistungs-Verhältnis und kaufe es.","fr":"Je choisirai le meilleur rapport qualité-prix et ferai l’achat."},"b":{"ru":"Сравню предложения, характеристики и отзывы перед оплатой.","en":"I’ll compare offers, specifications, and reviews before paying.","es":"Compararé ofertas, características y reseñas antes de pagar.","pt":"Vou comparar ofertas, características e avaliações antes de pagar.","de":"Ich vergleiche Angebote, Daten und Bewertungen vor dem Bezahlen.","fr":"Je comparerai les offres, caractéristiques et avis avant de payer."},"c":{"ru":"Отложу решение, чтобы убедиться, что покупка действительно нужна.","en":"I’ll postpone the decision to make sure I really need the purchase.","es":"Aplazaré la decisión para asegurarme de que realmente necesito comprarlo.","pt":"Vou adiar a decisão para ter a certeza de que a compra é realmente necessária.","de":"Ich verschiebe die Entscheidung, um sicherzugehen, dass ich den Kauf wirklich brauche.","fr":"Je reporterai la décision pour vérifier que cet achat est vraiment nécessaire."},"stats":{"a":48,"b":30,"c":22},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что ты делаешь, когда понимаешь, что день прошёл слишком быстро Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What do you do when you realize the day has passed too quickly What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué haces cuando te das cuenta de que el día pasó demasiado rápido ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que faz quando percebe que o dia passou rápido demais O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was machst du, wenn du merkst, dass der Tag zu schnell vergangen ist Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Que fais-tu lorsque tu réalises que la journée est passée trop vite Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу лучший вариант по цене и качеству и оформлю покупку.","en":"I’ll choose the best value for money and make the purchase.","es":"Elegiré la mejor relación calidad-precio y haré la compra.","pt":"Vou escolher a melhor relação qualidade-preço e fazer a compra.","de":"Ich wähle das beste Preis-Leistungs-Verhältnis und kaufe es.","fr":"Je choisirai le meilleur rapport qualité-prix et ferai l’achat."},"b":{"ru":"Сравню предложения, характеристики и отзывы перед оплатой.","en":"I’ll compare offers, specifications, and reviews before paying.","es":"Compararé ofertas, características y reseñas antes de pagar.","pt":"Vou comparar ofertas, características e avaliações antes de pagar.","de":"Ich vergleiche Angebote, Daten und Bewertungen vor dem Bezahlen.","fr":"Je comparerai les offres, caractéristiques et avis avant de payer."},"c":{"ru":"Отложу решение, чтобы убедиться, что покупка действительно нужна.","en":"I’ll postpone the decision to make sure I really need the purchase.","es":"Aplazaré la decisión para asegurarme de que realmente necesito comprarlo.","pt":"Vou adiar a decisão para ter a certeza de que a compra é realmente necessária.","de":"Ich verschiebe die Entscheidung, um sicherzugehen, dass ich den Kauf wirklich brauche.","fr":"Je reporterai la décision pour vérifier que cet achat est vraiment nécessaire."},"stats":{"a":49,"b":41,"c":10},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой момент дня ты стараешься не отдавать делам Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which part of the day do you try to keep free from tasks What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué momento del día intentas mantener libre de tareas ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que momento do dia você tenta manter livre de tarefas O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welchen Teil des Tages hältst du möglichst frei von Aufgaben Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel moment de la journée essaies-tu de garder libre de toute tâche Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу лучший вариант по цене и качеству и оформлю покупку.","en":"I’ll choose the best value for money and make the purchase.","es":"Elegiré la mejor relación calidad-precio y haré la compra.","pt":"Vou escolher a melhor relação qualidade-preço e fazer a compra.","de":"Ich wähle das beste Preis-Leistungs-Verhältnis und kaufe es.","fr":"Je choisirai le meilleur rapport qualité-prix et ferai l’achat."},"b":{"ru":"Сравню предложения, характеристики и отзывы перед оплатой.","en":"I’ll compare offers, specifications, and reviews before paying.","es":"Compararé ofertas, características y reseñas antes de pagar.","pt":"Vou comparar ofertas, características e avaliações antes de pagar.","de":"Ich vergleiche Angebote, Daten und Bewertungen vor dem Bezahlen.","fr":"Je comparerai les offres, caractéristiques et avis avant de payer."},"c":{"ru":"Отложу решение, чтобы убедиться, что покупка действительно нужна.","en":"I’ll postpone the decision to make sure I really need the purchase.","es":"Aplazaré la decisión para asegurarme de que realmente necesito comprarlo.","pt":"Vou adiar a decisão para ter a certeza de que a compra é realmente necessária.","de":"Ich verschiebe die Entscheidung, um sicherzugehen, dass ich den Kauf wirklich brauche.","fr":"Je reporterai la décision pour vérifier que cet achat est vraiment nécessaire."},"stats":{"a":56,"b":27,"c":17},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что тебе помогает перестать откладывать важное Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What helps you stop putting off something important What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué te ayuda a dejar de posponer algo importante ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que ajuda você a parar de adiar algo importante O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was hilft dir, etwas Wichtiges nicht länger aufzuschieben Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Qu’est-ce qui t’aide à ne plus repousser quelque chose d’important Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу лучший вариант по цене и качеству и оформлю покупку.","en":"I’ll choose the best value for money and make the purchase.","es":"Elegiré la mejor relación calidad-precio y haré la compra.","pt":"Vou escolher a melhor relação qualidade-preço e fazer a compra.","de":"Ich wähle das beste Preis-Leistungs-Verhältnis und kaufe es.","fr":"Je choisirai le meilleur rapport qualité-prix et ferai l’achat."},"b":{"ru":"Сравню предложения, характеристики и отзывы перед оплатой.","en":"I’ll compare offers, specifications, and reviews before paying.","es":"Compararé ofertas, características y reseñas antes de pagar.","pt":"Vou comparar ofertas, características e avaliações antes de pagar.","de":"Ich vergleiche Angebote, Daten und Bewertungen vor dem Bezahlen.","fr":"Je comparerai les offres, caractéristiques et avis avant de payer."},"c":{"ru":"Отложу решение, чтобы убедиться, что покупка действительно нужна.","en":"I’ll postpone the decision to make sure I really need the purchase.","es":"Aplazaré la decisión para asegurarme de que realmente necesito comprarlo.","pt":"Vou adiar a decisão para ter a certeza de que a compra é realmente necessária.","de":"Ich verschiebe die Entscheidung, um sicherzugehen, dass ich den Kauf wirklich brauche.","fr":"Je reporterai la décision pour vérifier que cet achat est vraiment nécessaire."},"stats":{"a":42,"b":38,"c":20},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Как ты выбираешь первую точку для прогулки в новом городе Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. How do you choose your first stop on a walk in a new city What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Cómo eliges el primer lugar para pasear en una ciudad nueva ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Como escolhe o primeiro lugar para passear em uma cidade nova O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Wie wählst du den ersten Ort für einen Spaziergang in einer neuen Stadt Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Comment choisis-tu ton premier lieu de promenade dans une nouvelle ville Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу лучший вариант по цене и качеству и оформлю покупку.","en":"I’ll choose the best value for money and make the purchase.","es":"Elegiré la mejor relación calidad-precio y haré la compra.","pt":"Vou escolher a melhor relação qualidade-preço e fazer a compra.","de":"Ich wähle das beste Preis-Leistungs-Verhältnis und kaufe es.","fr":"Je choisirai le meilleur rapport qualité-prix et ferai l’achat."},"b":{"ru":"Сравню предложения, характеристики и отзывы перед оплатой.","en":"I’ll compare offers, specifications, and reviews before paying.","es":"Compararé ofertas, características y reseñas antes de pagar.","pt":"Vou comparar ofertas, características e avaliações antes de pagar.","de":"Ich vergleiche Angebote, Daten und Bewertungen vor dem Bezahlen.","fr":"Je comparerai les offres, caractéristiques et avis avant de payer."},"c":{"ru":"Отложу решение, чтобы убедиться, что покупка действительно нужна.","en":"I’ll postpone the decision to make sure I really need the purchase.","es":"Aplazaré la decisión para asegurarme de que realmente necesito comprarlo.","pt":"Vou adiar a decisão para ter a certeza de que a compra é realmente necessária.","de":"Ich verschiebe die Entscheidung, um sicherzugehen, dass ich den Kauf wirklich brauche.","fr":"Je reporterai la décision pour vérifier que cet achat est vraiment nécessaire."},"stats":{"a":49,"b":24,"c":27},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что ты обязательно хочешь узнать перед далёкой поездкой Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What do you definitely want to know before a long trip What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué quieres saber sin falta antes de un viaje largo ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que você quer saber antes de uma viagem longa O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was möchtest du vor einer langen Reise unbedingt wissen Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Que veux-tu absolument savoir avant un long voyage Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу лучший вариант по цене и качеству и оформлю покупку.","en":"I’ll choose the best value for money and make the purchase.","es":"Elegiré la mejor relación calidad-precio y haré la compra.","pt":"Vou escolher a melhor relação qualidade-preço e fazer a compra.","de":"Ich wähle das beste Preis-Leistungs-Verhältnis und kaufe es.","fr":"Je choisirai le meilleur rapport qualité-prix et ferai l’achat."},"b":{"ru":"Сравню предложения, характеристики и отзывы перед оплатой.","en":"I’ll compare offers, specifications, and reviews before paying.","es":"Compararé ofertas, características y reseñas antes de pagar.","pt":"Vou comparar ofertas, características e avaliações antes de pagar.","de":"Ich vergleiche Angebote, Daten und Bewertungen vor dem Bezahlen.","fr":"Je comparerai les offres, caractéristiques et avis avant de payer."},"c":{"ru":"Отложу решение, чтобы убедиться, что покупка действительно нужна.","en":"I’ll postpone the decision to make sure I really need the purchase.","es":"Aplazaré la decisión para asegurarme de que realmente necesito comprarlo.","pt":"Vou adiar a decisão para ter a certeza de que a compra é realmente necessária.","de":"Ich verschiebe die Entscheidung, um sicherzugehen, dass ich den Kauf wirklich brauche.","fr":"Je reporterai la décision pour vérifier que cet achat est vraiment nécessaire."},"stats":{"a":50,"b":35,"c":15},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой сувенир кажется тебе самым удачным Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which souvenir seems like the best choice to you What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué recuerdo te parece el más acertado ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que lembrança parece mais acertada para você O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welches Souvenir erscheint dir am gelungensten Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel souvenir te semble le plus réussi Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу лучший вариант по цене и качеству и оформлю покупку.","en":"I’ll choose the best value for money and make the purchase.","es":"Elegiré la mejor relación calidad-precio y haré la compra.","pt":"Vou escolher a melhor relação qualidade-preço e fazer a compra.","de":"Ich wähle das beste Preis-Leistungs-Verhältnis und kaufe es.","fr":"Je choisirai le meilleur rapport qualité-prix et ferai l’achat."},"b":{"ru":"Сравню предложения, характеристики и отзывы перед оплатой.","en":"I’ll compare offers, specifications, and reviews before paying.","es":"Compararé ofertas, características y reseñas antes de pagar.","pt":"Vou comparar ofertas, características e avaliações antes de pagar.","de":"Ich vergleiche Angebote, Daten und Bewertungen vor dem Bezahlen.","fr":"Je comparerai les offres, caractéristiques et avis avant de payer."},"c":{"ru":"Отложу решение, чтобы убедиться, что покупка действительно нужна.","en":"I’ll postpone the decision to make sure I really need the purchase.","es":"Aplazaré la decisión para asegurarme de que realmente necesito comprarlo.","pt":"Vou adiar a decisão para ter a certeza de que a compra é realmente necessária.","de":"Ich verschiebe die Entscheidung, um sicherzugehen, dass ich den Kauf wirklich brauche.","fr":"Je reporterai la décision pour vérifier que cet achat est vraiment nécessaire."},"stats":{"a":36,"b":46,"c":18},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что ты предпочитаешь делать в месте, где оказался впервые Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What do you prefer to do in a place you are visiting for the first time What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué prefieres hacer en un lugar que visitas por primera vez ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que prefere fazer em um lugar onde está pela primeira vez O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was machst du am liebsten an einem Ort, an dem du zum ersten Mal bist Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Que préfères-tu faire dans un endroit que tu découvres pour la première fois Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу лучший вариант по цене и качеству и оформлю покупку.","en":"I’ll choose the best value for money and make the purchase.","es":"Elegiré la mejor relación calidad-precio y haré la compra.","pt":"Vou escolher a melhor relação qualidade-preço e fazer a compra.","de":"Ich wähle das beste Preis-Leistungs-Verhältnis und kaufe es.","fr":"Je choisirai le meilleur rapport qualité-prix et ferai l’achat."},"b":{"ru":"Сравню предложения, характеристики и отзывы перед оплатой.","en":"I’ll compare offers, specifications, and reviews before paying.","es":"Compararé ofertas, características y reseñas antes de pagar.","pt":"Vou comparar ofertas, características e avaliações antes de pagar.","de":"Ich vergleiche Angebote, Daten und Bewertungen vor dem Bezahlen.","fr":"Je comparerai les offres, caractéristiques et avis avant de payer."},"c":{"ru":"Отложу решение, чтобы убедиться, что покупка действительно нужна.","en":"I’ll postpone the decision to make sure I really need the purchase.","es":"Aplazaré la decisión para asegurarme de que realmente necesito comprarlo.","pt":"Vou adiar a decisão para ter a certeza de que a compra é realmente necessária.","de":"Ich verschiebe die Entscheidung, um sicherzugehen, dass ich den Kauf wirklich brauche.","fr":"Je reporterai la décision pour vérifier que cet achat est vraiment nécessaire."},"stats":{"a":43,"b":32,"c":25},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой тип путешествия тебе запоминается сильнее всего Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which type of trip stays in your memory most strongly What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué tipo de viaje recuerdas con más intensidad ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que tipo de viagem fica mais forte na sua memória O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welche Art von Reise bleibt dir am stärksten im Gedächtnis Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel type de voyage reste le plus fortement dans ta mémoire Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу лучший вариант по цене и качеству и оформлю покупку.","en":"I’ll choose the best value for money and make the purchase.","es":"Elegiré la mejor relación calidad-precio y haré la compra.","pt":"Vou escolher a melhor relação qualidade-preço e fazer a compra.","de":"Ich wähle das beste Preis-Leistungs-Verhältnis und kaufe es.","fr":"Je choisirai le meilleur rapport qualité-prix et ferai l’achat."},"b":{"ru":"Сравню предложения, характеристики и отзывы перед оплатой.","en":"I’ll compare offers, specifications, and reviews before paying.","es":"Compararé ofertas, características y reseñas antes de pagar.","pt":"Vou comparar ofertas, características e avaliações antes de pagar.","de":"Ich vergleiche Angebote, Daten und Bewertungen vor dem Bezahlen.","fr":"Je comparerai les offres, caractéristiques et avis avant de payer."},"c":{"ru":"Отложу решение, чтобы убедиться, что покупка действительно нужна.","en":"I’ll postpone the decision to make sure I really need the purchase.","es":"Aplazaré la decisión para asegurarme de que realmente necesito comprarlo.","pt":"Vou adiar a decisão para ter a certeza de que a compra é realmente necessária.","de":"Ich verschiebe die Entscheidung, um sicherzugehen, dass ich den Kauf wirklich brauche.","fr":"Je reporterai la décision pour vérifier que cet achat est vraiment nécessaire."},"stats":{"a":44,"b":43,"c":13},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой предмет дома делает пространство по-настоящему твоим Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which item at home makes the space feel truly yours What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué objeto de tu casa hace que el espacio se sienta realmente tuyo ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que objeto de casa faz o espaço parecer realmente seu O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welcher Gegenstand zu Hause macht den Raum wirklich zu deinem Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel objet de chez toi rend vraiment l’espace à ton image Que feras-tu dans cette situation ?"},"a":{"ru":"Сразу выберу маршрут и начну исследовать место.","en":"I’ll pick a route immediately and start exploring.","es":"Elegiré una ruta de inmediato y empezaré a explorar.","pt":"Vou escolher um caminho de imediato e começar a explorar.","de":"Ich wähle sofort eine Route und beginne zu erkunden.","fr":"Je choisirai tout de suite un itinéraire et commencerai à explorer."},"b":{"ru":"Сначала изучу основные точки и составлю гибкий план.","en":"I’ll check the main spots first and make a flexible plan.","es":"Primero localizaré los puntos principales y haré un plan flexible.","pt":"Primeiro vou ver os pontos principais e fazer um plano flexível.","de":"Ich informiere mich zuerst über die wichtigsten Orte und erstelle einen flexiblen Plan.","fr":"Je repérerai d’abord les lieux principaux et ferai un plan flexible."},"c":{"ru":"Поспрашиваю местных и выберу путь по их советам.","en":"I’ll ask locals and choose a route based on their advice.","es":"Preguntaré a los locales y elegiré la ruta según sus consejos.","pt":"Vou perguntar aos locais e escolher o caminho com base nas recomendações.","de":"Ich frage Einheimische und wähle den Weg nach ihren Empfehlungen.","fr":"Je demanderai aux habitants et choisirai mon itinéraire selon leurs conseils."},"stats":{"a":57,"b":29,"c":14},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что ты изменил бы в комнате, если бы получил полный карт-бланш Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What would you change in your room if you had complete freedom What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué cambiarías en tu habitación si tuvieras libertad total ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que mudaria no seu quarto se tivesse liberdade total O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was würdest du in deinem Zimmer ändern, wenn du völlig freie Hand hättest Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Que changerais-tu dans ta chambre avec une liberté totale Que feras-tu dans cette situation ?"},"a":{"ru":"Сразу выберу маршрут и начну исследовать место.","en":"I’ll pick a route immediately and start exploring.","es":"Elegiré una ruta de inmediato y empezaré a explorar.","pt":"Vou escolher um caminho de imediato e começar a explorar.","de":"Ich wähle sofort eine Route und beginne zu erkunden.","fr":"Je choisirai tout de suite un itinéraire et commencerai à explorer."},"b":{"ru":"Сначала изучу основные точки и составлю гибкий план.","en":"I’ll check the main spots first and make a flexible plan.","es":"Primero localizaré los puntos principales y haré un plan flexible.","pt":"Primeiro vou ver os pontos principais e fazer um plano flexível.","de":"Ich informiere mich zuerst über die wichtigsten Orte und erstelle einen flexiblen Plan.","fr":"Je repérerai d’abord les lieux principaux et ferai un plan flexible."},"c":{"ru":"Поспрашиваю местных и выберу путь по их советам.","en":"I’ll ask locals and choose a route based on their advice.","es":"Preguntaré a los locales y elegiré la ruta según sus consejos.","pt":"Vou perguntar aos locais e escolher o caminho com base nas recomendações.","de":"Ich frage Einheimische und wähle den Weg nach ihren Empfehlungen.","fr":"Je demanderai aux habitants et choisirai mon itinéraire selon leurs conseils."},"stats":{"a":37,"b":40,"c":23},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой домашний звук тебе приятнее всего Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which household sound do you like most What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué sonido de casa te resulta más agradable ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Qual som de casa é mais agradável para você O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welches Geräusch zu Hause gefällt dir am besten Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel bruit de la maison te plaît le plus Que feras-tu dans cette situation ?"},"a":{"ru":"Сразу выберу маршрут и начну исследовать место.","en":"I’ll pick a route immediately and start exploring.","es":"Elegiré una ruta de inmediato y empezaré a explorar.","pt":"Vou escolher um caminho de imediato e começar a explorar.","de":"Ich wähle sofort eine Route und beginne zu erkunden.","fr":"Je choisirai tout de suite un itinéraire et commencerai à explorer."},"b":{"ru":"Сначала изучу основные точки и составлю гибкий план.","en":"I’ll check the main spots first and make a flexible plan.","es":"Primero localizaré los puntos principales y haré un plan flexible.","pt":"Primeiro vou ver os pontos principais e fazer um plano flexível.","de":"Ich informiere mich zuerst über die wichtigsten Orte und erstelle einen flexiblen Plan.","fr":"Je repérerai d’abord les lieux principaux et ferai un plan flexible."},"c":{"ru":"Поспрашиваю местных и выберу путь по их советам.","en":"I’ll ask locals and choose a route based on their advice.","es":"Preguntaré a los locales y elegiré la ruta según sus consejos.","pt":"Vou perguntar aos locais e escolher o caminho com base nas recomendações.","de":"Ich frage Einheimische und wähle den Weg nach ihren Empfehlungen.","fr":"Je demanderai aux habitants et choisirai mon itinéraire selon leurs conseils."},"stats":{"a":44,"b":26,"c":30},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Как ты решаешь, что пора расхламлять шкаф Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. How do you decide that it is time to declutter your wardrobe What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Cómo decides que ha llegado el momento de ordenar tu armario ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Como decide que é hora de organizar o guarda-roupa O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Wie entscheidest du, dass es Zeit ist, den Kleiderschrank auszumisten Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Comment décides-tu qu’il est temps de trier ton armoire Que feras-tu dans cette situation ?"},"a":{"ru":"Сразу выберу маршрут и начну исследовать место.","en":"I’ll pick a route immediately and start exploring.","es":"Elegiré una ruta de inmediato y empezaré a explorar.","pt":"Vou escolher um caminho de imediato e começar a explorar.","de":"Ich wähle sofort eine Route und beginne zu erkunden.","fr":"Je choisirai tout de suite un itinéraire et commencerai à explorer."},"b":{"ru":"Сначала изучу основные точки и составлю гибкий план.","en":"I’ll check the main spots first and make a flexible plan.","es":"Primero localizaré los puntos principales y haré un plan flexible.","pt":"Primeiro vou ver os pontos principais e fazer um plano flexível.","de":"Ich informiere mich zuerst über die wichtigsten Orte und erstelle einen flexiblen Plan.","fr":"Je repérerai d’abord les lieux principaux et ferai un plan flexible."},"c":{"ru":"Поспрашиваю местных и выберу путь по их советам.","en":"I’ll ask locals and choose a route based on their advice.","es":"Preguntaré a los locales y elegiré la ruta según sus consejos.","pt":"Vou perguntar aos locais e escolher o caminho com base nas recomendações.","de":"Ich frage Einheimische und wähle den Weg nach ihren Empfehlungen.","fr":"Je demanderai aux habitants et choisirai mon itinéraire selon leurs conseils."},"stats":{"a":51,"b":37,"c":12},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что важнее для хорошего вечера дома Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What matters most for a good evening at home What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué es lo más importante para una buena noche en casa ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que é mais importante para uma boa noite em casa O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was ist für einen guten Abend zu Hause am wichtigsten Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Qu’est-ce qui compte le plus pour une bonne soirée à la maison Que feras-tu dans cette situation ?"},"a":{"ru":"Сразу выберу маршрут и начну исследовать место.","en":"I’ll pick a route immediately and start exploring.","es":"Elegiré una ruta de inmediato y empezaré a explorar.","pt":"Vou escolher um caminho de imediato e começar a explorar.","de":"Ich wähle sofort eine Route und beginne zu erkunden.","fr":"Je choisirai tout de suite un itinéraire et commencerai à explorer."},"b":{"ru":"Сначала изучу основные точки и составлю гибкий план.","en":"I’ll check the main spots first and make a flexible plan.","es":"Primero localizaré los puntos principales y haré un plan flexible.","pt":"Primeiro vou ver os pontos principais e fazer um plano flexível.","de":"Ich informiere mich zuerst über die wichtigsten Orte und erstelle einen flexiblen Plan.","fr":"Je repérerai d’abord les lieux principaux et ferai un plan flexible."},"c":{"ru":"Поспрашиваю местных и выберу путь по их советам.","en":"I’ll ask locals and choose a route based on their advice.","es":"Preguntaré a los locales y elegiré la ruta según sus consejos.","pt":"Vou perguntar aos locais e escolher o caminho com base nas recomendações.","de":"Ich frage Einheimische und wähle den Weg nach ihren Empfehlungen.","fr":"Je demanderai aux habitants et choisirai mon itinéraire selon leurs conseils."},"stats":{"a":52,"b":48,"c":0},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какое блюдо ты бы научился готовить идеально Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which dish would you like to learn to cook perfectly What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué plato te gustaría aprender a cocinar a la perfección ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que prato gostaria de aprender a cozinhar perfeitamente O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welches Gericht würdest du gern perfekt kochen können Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel plat aimerais-tu apprendre à cuisiner à la perfection Que feras-tu dans cette situation ?"},"a":{"ru":"Сразу выберу маршрут и начну исследовать место.","en":"I’ll pick a route immediately and start exploring.","es":"Elegiré una ruta de inmediato y empezaré a explorar.","pt":"Vou escolher um caminho de imediato e começar a explorar.","de":"Ich wähle sofort eine Route und beginne zu erkunden.","fr":"Je choisirai tout de suite un itinéraire et commencerai à explorer."},"b":{"ru":"Сначала изучу основные точки и составлю гибкий план.","en":"I’ll check the main spots first and make a flexible plan.","es":"Primero localizaré los puntos principales y haré un plan flexible.","pt":"Primeiro vou ver os pontos principais e fazer um plano flexível.","de":"Ich informiere mich zuerst über die wichtigsten Orte und erstelle einen flexiblen Plan.","fr":"Je repérerai d’abord les lieux principaux et ferai un plan flexible."},"c":{"ru":"Поспрашиваю местных и выберу путь по их советам.","en":"I’ll ask locals and choose a route based on their advice.","es":"Preguntaré a los locales y elegiré la ruta según sus consejos.","pt":"Vou perguntar aos locais e escolher o caminho com base nas recomendações.","de":"Ich frage Einheimische und wähle den Weg nach ihren Empfehlungen.","fr":"Je demanderai aux habitants et choisirai mon itinéraire selon leurs conseils."},"stats":{"a":38,"b":34,"c":28},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что ты скорее выберешь в незнакомом ресторане Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What are you most likely to choose in an unfamiliar restaurant What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué elegirías en un restaurante desconocido ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que provavelmente escolheria em um restaurante desconhecido O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was würdest du in einem unbekannten Restaurant am ehesten wählen Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Que choisirais-tu dans un restaurant inconnu Que feras-tu dans cette situation ?"},"a":{"ru":"Сразу выберу маршрут и начну исследовать место.","en":"I’ll pick a route immediately and start exploring.","es":"Elegiré una ruta de inmediato y empezaré a explorar.","pt":"Vou escolher um caminho de imediato e começar a explorar.","de":"Ich wähle sofort eine Route und beginne zu erkunden.","fr":"Je choisirai tout de suite un itinéraire et commencerai à explorer."},"b":{"ru":"Сначала изучу основные точки и составлю гибкий план.","en":"I’ll check the main spots first and make a flexible plan.","es":"Primero localizaré los puntos principales y haré un plan flexible.","pt":"Primeiro vou ver os pontos principais e fazer um plano flexível.","de":"Ich informiere mich zuerst über die wichtigsten Orte und erstelle einen flexiblen Plan.","fr":"Je repérerai d’abord les lieux principaux et ferai un plan flexible."},"c":{"ru":"Поспрашиваю местных и выберу путь по их советам.","en":"I’ll ask locals and choose a route based on their advice.","es":"Preguntaré a los locales y elegiré la ruta según sus consejos.","pt":"Vou perguntar aos locais e escolher o caminho com base nas recomendações.","de":"Ich frage Einheimische und wähle den Weg nach ihren Empfehlungen.","fr":"Je demanderai aux habitants et choisirai mon itinéraire selon leurs conseils."},"stats":{"a":39,"b":45,"c":16},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой продукт всегда должен быть на твоей кухне Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which product should always be in your kitchen What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué producto debería estar siempre en tu cocina ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que produto sempre deveria existir na sua cozinha O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welches Produkt sollte immer in deiner Küche vorhanden sein Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel produit doit toujours être présent dans ta cuisine Que feras-tu dans cette situation ?"},"a":{"ru":"Сразу выберу маршрут и начну исследовать место.","en":"I’ll pick a route immediately and start exploring.","es":"Elegiré una ruta de inmediato y empezaré a explorar.","pt":"Vou escolher um caminho de imediato e começar a explorar.","de":"Ich wähle sofort eine Route und beginne zu erkunden.","fr":"Je choisirai tout de suite un itinéraire et commencerai à explorer."},"b":{"ru":"Сначала изучу основные точки и составлю гибкий план.","en":"I’ll check the main spots first and make a flexible plan.","es":"Primero localizaré los puntos principales y haré un plan flexible.","pt":"Primeiro vou ver os pontos principais e fazer um plano flexível.","de":"Ich informiere mich zuerst über die wichtigsten Orte und erstelle einen flexiblen Plan.","fr":"Je repérerai d’abord les lieux principaux et ferai un plan flexible."},"c":{"ru":"Поспрашиваю местных и выберу путь по их советам.","en":"I’ll ask locals and choose a route based on their advice.","es":"Preguntaré a los locales y elegiré la ruta según sus consejos.","pt":"Vou perguntar aos locais e escolher o caminho com base nas recomendações.","de":"Ich frage Einheimische und wähle den Weg nach ihren Empfehlungen.","fr":"Je demanderai aux habitants et choisirai mon itinéraire selon leurs conseils."},"stats":{"a":52,"b":31,"c":17},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Как ты относишься к рецептам, которые заметно меняют привычное блюдо Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. How do you feel about recipes that noticeably change a familiar dish What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Cómo ves las recetas que cambian mucho un plato conocido ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Como vê receitas que mudam bastante um prato conhecido O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Wie findest du Rezepte, die ein bekanntes Gericht deutlich verändern Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Que penses-tu des recettes qui transforment nettement un plat habituel Que feras-tu dans cette situation ?"},"a":{"ru":"Сразу выберу маршрут и начну исследовать место.","en":"I’ll pick a route immediately and start exploring.","es":"Elegiré una ruta de inmediato y empezaré a explorar.","pt":"Vou escolher um caminho de imediato e começar a explorar.","de":"Ich wähle sofort eine Route und beginne zu erkunden.","fr":"Je choisirai tout de suite un itinéraire et commencerai à explorer."},"b":{"ru":"Сначала изучу основные точки и составлю гибкий план.","en":"I’ll check the main spots first and make a flexible plan.","es":"Primero localizaré los puntos principales y haré un plan flexible.","pt":"Primeiro vou ver os pontos principais e fazer um plano flexível.","de":"Ich informiere mich zuerst über die wichtigsten Orte und erstelle einen flexiblen Plan.","fr":"Je repérerai d’abord les lieux principaux et ferai un plan flexible."},"c":{"ru":"Поспрашиваю местных и выберу путь по их советам.","en":"I’ll ask locals and choose a route based on their advice.","es":"Preguntaré a los locales y elegiré la ruta según sus consejos.","pt":"Vou perguntar aos locais e escolher o caminho com base nas recomendações.","de":"Ich frage Einheimische und wähle den Weg nach ihren Empfehlungen.","fr":"Je demanderai aux habitants et choisirai mon itinéraire selon leurs conseils."},"stats":{"a":53,"b":42,"c":5},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что делает обычный ужин особенным для тебя Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What makes an ordinary dinner special for you What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué hace especial una cena normal para ti ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que torna um jantar comum especial para você O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was macht ein gewöhnliches Abendessen für dich besonders Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Qu’est-ce qui rend un dîner ordinaire spécial pour toi Que feras-tu dans cette situation ?"},"a":{"ru":"Сразу выберу маршрут и начну исследовать место.","en":"I’ll pick a route immediately and start exploring.","es":"Elegiré una ruta de inmediato y empezaré a explorar.","pt":"Vou escolher um caminho de imediato e começar a explorar.","de":"Ich wähle sofort eine Route und beginne zu erkunden.","fr":"Je choisirai tout de suite un itinéraire et commencerai à explorer."},"b":{"ru":"Сначала изучу основные точки и составлю гибкий план.","en":"I’ll check the main spots first and make a flexible plan.","es":"Primero localizaré los puntos principales y haré un plan flexible.","pt":"Primeiro vou ver os pontos principais e fazer um plano flexível.","de":"Ich informiere mich zuerst über die wichtigsten Orte und erstelle einen flexiblen Plan.","fr":"Je repérerai d’abord les lieux principaux et ferai un plan flexible."},"c":{"ru":"Поспрашиваю местных и выберу путь по их советам.","en":"I’ll ask locals and choose a route based on their advice.","es":"Preguntaré a los locales y elegiré la ruta según sus consejos.","pt":"Vou perguntar aos locais e escolher o caminho com base nas recomendações.","de":"Ich frage Einheimische und wähle den Weg nach ihren Empfehlungen.","fr":"Je demanderai aux habitants et choisirai mon itinéraire selon leurs conseils."},"stats":{"a":39,"b":28,"c":33},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какую книгу ты бы хотел забыть и прочитать заново Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which book would you like to forget and read again What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué libro te gustaría olvidar para poder leerlo de nuevo ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que livro gostaria de esquecer e ler novamente O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welches Buch würdest du gern vergessen und noch einmal lesen Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel livre aimerais-tu oublier afin de le relire Que feras-tu dans cette situation ?"},"a":{"ru":"Оставлю всё как есть, если это работает и меня устраивает.","en":"I’ll leave it as it is if it works and suits me.","es":"Lo dejaré como está si funciona y me conviene.","pt":"Vou deixar como está se funcionar e me servir.","de":"Ich lasse es so, wenn es funktioniert und für mich passt.","fr":"Je laisserai les choses telles quelles si cela fonctionne et me convient."},"b":{"ru":"Изменю главное, что мешает, и проверю результат.","en":"I’ll change the main problem and check the result.","es":"Cambiaré lo principal que molesta y comprobaré el resultado.","pt":"Vou mudar o principal problema e verificar o resultado.","de":"Ich ändere das Wichtigste, was stört, und prüfe das Ergebnis.","fr":"Je changerai le principal problème et vérifierai le résultat."},"c":{"ru":"Перестрою всё постепенно, чтобы не создать новых проблем.","en":"I’ll rebuild it gradually to avoid creating new problems.","es":"Lo reorganizaré poco a poco para no crear nuevos problemas.","pt":"Vou reorganizar tudo aos poucos para não criar novos problemas.","de":"Ich stelle es schrittweise um, damit keine neuen Probleme entstehen.","fr":"Je réorganiserai progressivement pour ne pas créer de nouveaux problèmes."},"stats":{"a":46,"b":39,"c":15},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что сильнее удерживает твоё внимание в романе Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What keeps your attention most strongly in a novel What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué mantiene más tu atención en una novela ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que mais prende sua atenção em um romance O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was hält deine Aufmerksamkeit in einem Roman am stärksten Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Qu’est-ce qui retient le plus ton attention dans un roman Que feras-tu dans cette situation ?"},"a":{"ru":"Оставлю всё как есть, если это работает и меня устраивает.","en":"I’ll leave it as it is if it works and suits me.","es":"Lo dejaré como está si funciona y me conviene.","pt":"Vou deixar como está se funcionar e me servir.","de":"Ich lasse es so, wenn es funktioniert und für mich passt.","fr":"Je laisserai les choses telles quelles si cela fonctionne et me convient."},"b":{"ru":"Изменю главное, что мешает, и проверю результат.","en":"I’ll change the main problem and check the result.","es":"Cambiaré lo principal que molesta y comprobaré el resultado.","pt":"Vou mudar o principal problema e verificar o resultado.","de":"Ich ändere das Wichtigste, was stört, und prüfe das Ergebnis.","fr":"Je changerai le principal problème et vérifierai le résultat."},"c":{"ru":"Перестрою всё постепенно, чтобы не создать новых проблем.","en":"I’ll rebuild it gradually to avoid creating new problems.","es":"Lo reorganizaré poco a poco para no crear nuevos problemas.","pt":"Vou reorganizar tudo aos poucos para não criar novos problemas.","de":"Ich stelle es schrittweise um, damit keine neuen Probleme entstehen.","fr":"Je réorganiserai progressivement pour ne pas créer de nouveaux problèmes."},"stats":{"a":53,"b":25,"c":22},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой формат чтения тебе удобнее в дороге Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which reading format is most convenient for you while traveling What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué formato de lectura te resulta más cómodo de viaje ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Qual formato de leitura é mais conveniente durante uma viagem O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welche Leseform ist unterwegs für dich am angenehmsten Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel format de lecture est le plus pratique pour toi en voyage Que feras-tu dans cette situation ?"},"a":{"ru":"Оставлю всё как есть, если это работает и меня устраивает.","en":"I’ll leave it as it is if it works and suits me.","es":"Lo dejaré como está si funciona y me conviene.","pt":"Vou deixar como está se funcionar e me servir.","de":"Ich lasse es so, wenn es funktioniert und für mich passt.","fr":"Je laisserai les choses telles quelles si cela fonctionne et me convient."},"b":{"ru":"Изменю главное, что мешает, и проверю результат.","en":"I’ll change the main problem and check the result.","es":"Cambiaré lo principal que molesta y comprobaré el resultado.","pt":"Vou mudar o principal problema e verificar o resultado.","de":"Ich ändere das Wichtigste, was stört, und prüfe das Ergebnis.","fr":"Je changerai le principal problème et vérifierai le résultat."},"c":{"ru":"Перестрою всё постепенно, чтобы не создать новых проблем.","en":"I’ll rebuild it gradually to avoid creating new problems.","es":"Lo reorganizaré poco a poco para no crear nuevos problemas.","pt":"Vou reorganizar tudo aos poucos para não criar novos problemas.","de":"Ich stelle es schrittweise um, damit keine neuen Probleme entstehen.","fr":"Je réorganiserai progressivement pour ne pas créer de nouveaux problèmes."},"stats":{"a":54,"b":36,"c":10},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Как ты выбираешь следующую книгу Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. How do you choose your next book What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Cómo eliges el siguiente libro ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Como escolhe o próximo livro O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Wie wählst du dein nächstes Buch aus Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Comment choisis-tu ton prochain livre Que feras-tu dans cette situation ?"},"a":{"ru":"Оставлю всё как есть, если это работает и меня устраивает.","en":"I’ll leave it as it is if it works and suits me.","es":"Lo dejaré como está si funciona y me conviene.","pt":"Vou deixar como está se funcionar e me servir.","de":"Ich lasse es so, wenn es funktioniert und für mich passt.","fr":"Je laisserai les choses telles quelles si cela fonctionne et me convient."},"b":{"ru":"Изменю главное, что мешает, и проверю результат.","en":"I’ll change the main problem and check the result.","es":"Cambiaré lo principal que molesta y comprobaré el resultado.","pt":"Vou mudar o principal problema e verificar o resultado.","de":"Ich ändere das Wichtigste, was stört, und prüfe das Ergebnis.","fr":"Je changerai le principal problème et vérifierai le résultat."},"c":{"ru":"Перестрою всё постепенно, чтобы не создать новых проблем.","en":"I’ll rebuild it gradually to avoid creating new problems.","es":"Lo reorganizaré poco a poco para no crear nuevos problemas.","pt":"Vou reorganizar tudo aos poucos para não criar novos problemas.","de":"Ich stelle es schrittweise um, damit keine neuen Probleme entstehen.","fr":"Je réorganiserai progressivement pour ne pas créer de nouveaux problèmes."},"stats":{"a":40,"b":47,"c":13},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что ты предпочитаешь узнать о герое прежде всего Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What do you prefer to learn about a character first What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué prefieres descubrir primero sobre un personaje ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que prefere descobrir primeiro sobre um personagem O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was möchtest du über eine Figur zuerst wissen Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Que préfères-tu découvrir en premier chez un personnage Que feras-tu dans cette situation ?"},"a":{"ru":"Оставлю всё как есть, если это работает и меня устраивает.","en":"I’ll leave it as it is if it works and suits me.","es":"Lo dejaré como está si funciona y me conviene.","pt":"Vou deixar como está se funcionar e me servir.","de":"Ich lasse es so, wenn es funktioniert und für mich passt.","fr":"Je laisserai les choses telles quelles si cela fonctionne et me convient."},"b":{"ru":"Изменю главное, что мешает, и проверю результат.","en":"I’ll change the main problem and check the result.","es":"Cambiaré lo principal que molesta y comprobaré el resultado.","pt":"Vou mudar o principal problema e verificar o resultado.","de":"Ich ändere das Wichtigste, was stört, und prüfe das Ergebnis.","fr":"Je changerai le principal problème et vérifierai le résultat."},"c":{"ru":"Перестрою всё постепенно, чтобы не создать новых проблем.","en":"I’ll rebuild it gradually to avoid creating new problems.","es":"Lo reorganizaré poco a poco para no crear nuevos problemas.","pt":"Vou reorganizar tudo aos poucos para não criar novos problemas.","de":"Ich stelle es schrittweise um, damit keine neuen Probleme entstehen.","fr":"Je réorganiserai progressivement pour ne pas créer de nouveaux problèmes."},"stats":{"a":47,"b":33,"c":20},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что заставляет тебя досмотреть фильм до конца Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What makes you watch a film all the way to the end What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué hace que veas una película hasta el final ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que faz você assistir a um filme até o fim O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was bringt dich dazu, einen Film bis zum Ende zu sehen Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Qu’est-ce qui te pousse à regarder un film jusqu’à la fin Que feras-tu dans cette situation ?"},"a":{"ru":"Оставлю всё как есть, если это работает и меня устраивает.","en":"I’ll leave it as it is if it works and suits me.","es":"Lo dejaré como está si funciona y me conviene.","pt":"Vou deixar como está se funcionar e me servir.","de":"Ich lasse es so, wenn es funktioniert und für mich passt.","fr":"Je laisserai les choses telles quelles si cela fonctionne et me convient."},"b":{"ru":"Изменю главное, что мешает, и проверю результат.","en":"I’ll change the main problem and check the result.","es":"Cambiaré lo principal que molesta y comprobaré el resultado.","pt":"Vou mudar o principal problema e verificar o resultado.","de":"Ich ändere das Wichtigste, was stört, und prüfe das Ergebnis.","fr":"Je changerai le principal problème et vérifierai le résultat."},"c":{"ru":"Перестрою всё постепенно, чтобы не создать новых проблем.","en":"I’ll rebuild it gradually to avoid creating new problems.","es":"Lo reorganizaré poco a poco para no crear nuevos problemas.","pt":"Vou reorganizar tudo aos poucos para não criar novos problemas.","de":"Ich stelle es schrittweise um, damit keine neuen Probleme entstehen.","fr":"Je réorganiserai progressivement pour ne pas créer de nouveaux problèmes."},"stats":{"a":48,"b":44,"c":8},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой жанр ты выберешь для дождливого вечера Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which genre would you choose for a rainy evening What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué género elegirías para una tarde lluviosa ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que gênero escolheria para uma noite chuvosa O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welches Genre würdest du für einen regnerischen Abend wählen Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel genre choisirais-tu pour une soirée pluvieuse Que feras-tu dans cette situation ?"},"a":{"ru":"Оставлю всё как есть, если это работает и меня устраивает.","en":"I’ll leave it as it is if it works and suits me.","es":"Lo dejaré como está si funciona y me conviene.","pt":"Vou deixar como está se funcionar e me servir.","de":"Ich lasse es so, wenn es funktioniert und für mich passt.","fr":"Je laisserai les choses telles quelles si cela fonctionne et me convient."},"b":{"ru":"Изменю главное, что мешает, и проверю результат.","en":"I’ll change the main problem and check the result.","es":"Cambiaré lo principal que molesta y comprobaré el resultado.","pt":"Vou mudar o principal problema e verificar o resultado.","de":"Ich ändere das Wichtigste, was stört, und prüfe das Ergebnis.","fr":"Je changerai le principal problème et vérifierai le résultat."},"c":{"ru":"Перестрою всё постепенно, чтобы не создать новых проблем.","en":"I’ll rebuild it gradually to avoid creating new problems.","es":"Lo reorganizaré poco a poco para no crear nuevos problemas.","pt":"Vou reorganizar tudo aos poucos para não criar novos problemas.","de":"Ich stelle es schrittweise um, damit keine neuen Probleme entstehen.","fr":"Je réorganiserai progressivement pour ne pas créer de nouveaux problèmes."},"stats":{"a":55,"b":30,"c":15},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что важнее для тебя в кино: сюжет, атмосфера или персонажи Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What matters more to you in a film: plot, atmosphere, or characters What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué es más importante para ti en el cine: trama, ambiente o personajes ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que é mais importante para você no cinema: enredo, atmosfera ou personagens O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was ist dir im Film wichtiger: Handlung, Atmosphäre oder Figuren Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Au cinéma, qu’est-ce qui compte le plus pour toi : l’intrigue, l’atmosphère ou les personnages Que feras-tu dans cette situation ?"},"a":{"ru":"Оставлю всё как есть, если это работает и меня устраивает.","en":"I’ll leave it as it is if it works and suits me.","es":"Lo dejaré como está si funciona y me conviene.","pt":"Vou deixar como está se funcionar e me servir.","de":"Ich lasse es so, wenn es funktioniert und für mich passt.","fr":"Je laisserai les choses telles quelles si cela fonctionne et me convient."},"b":{"ru":"Изменю главное, что мешает, и проверю результат.","en":"I’ll change the main problem and check the result.","es":"Cambiaré lo principal que molesta y comprobaré el resultado.","pt":"Vou mudar o principal problema e verificar o resultado.","de":"Ich ändere das Wichtigste, was stört, und prüfe das Ergebnis.","fr":"Je changerai le principal problème et vérifierai le résultat."},"c":{"ru":"Перестрою всё постепенно, чтобы не создать новых проблем.","en":"I’ll rebuild it gradually to avoid creating new problems.","es":"Lo reorganizaré poco a poco para no crear nuevos problemas.","pt":"Vou reorganizar tudo aos poucos para não criar novos problemas.","de":"Ich stelle es schrittweise um, damit keine neuen Probleme entstehen.","fr":"Je réorganiserai progressivement pour ne pas créer de nouveaux problèmes."},"stats":{"a":41,"b":41,"c":18},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Как ты относишься к финалам, которые оставляют вопросы Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. How do you feel about endings that leave questions unanswered What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Cómo ves los finales que dejan preguntas abiertas ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Como vê finais que deixam perguntas no ar O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Wie stehst du zu Enden, die Fragen offenlassen Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Que penses-tu des fins qui laissent des questions sans réponse Que feras-tu dans cette situation ?"},"a":{"ru":"Оставлю всё как есть, если это работает и меня устраивает.","en":"I’ll leave it as it is if it works and suits me.","es":"Lo dejaré como está si funciona y me conviene.","pt":"Vou deixar como está se funcionar e me servir.","de":"Ich lasse es so, wenn es funktioniert und für mich passt.","fr":"Je laisserai les choses telles quelles si cela fonctionne et me convient."},"b":{"ru":"Изменю главное, что мешает, и проверю результат.","en":"I’ll change the main problem and check the result.","es":"Cambiaré lo principal que molesta y comprobaré el resultado.","pt":"Vou mudar o principal problema e verificar o resultado.","de":"Ich ändere das Wichtigste, was stört, und prüfe das Ergebnis.","fr":"Je changerai le principal problème et vérifierai le résultat."},"c":{"ru":"Перестрою всё постепенно, чтобы не создать новых проблем.","en":"I’ll rebuild it gradually to avoid creating new problems.","es":"Lo reorganizaré poco a poco para no crear nuevos problemas.","pt":"Vou reorganizar tudo aos poucos para não criar novos problemas.","de":"Ich stelle es schrittweise um, damit keine neuen Probleme entstehen.","fr":"Je réorganiserai progressivement pour ne pas créer de nouveaux problèmes."},"stats":{"a":48,"b":27,"c":25},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой фильм ты бы показал человеку, чтобы познакомить его со своим вкусом Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which film would you show someone to introduce them to your taste What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué película mostrarías para presentar tu gusto a otra persona ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que filme mostraria para apresentar seu gosto a alguém O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welchen Film würdest du jemandem zeigen, um deinen Geschmack vorzustellen Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel film montrerais-tu à quelqu’un pour lui faire découvrir tes goûts Que feras-tu dans cette situation ?"},"a":{"ru":"Оставлю всё как есть, если это работает и меня устраивает.","en":"I’ll leave it as it is if it works and suits me.","es":"Lo dejaré como está si funciona y me conviene.","pt":"Vou deixar como está se funcionar e me servir.","de":"Ich lasse es so, wenn es funktioniert und für mich passt.","fr":"Je laisserai les choses telles quelles si cela fonctionne et me convient."},"b":{"ru":"Изменю главное, что мешает, и проверю результат.","en":"I’ll change the main problem and check the result.","es":"Cambiaré lo principal que molesta y comprobaré el resultado.","pt":"Vou mudar o principal problema e verificar o resultado.","de":"Ich ändere das Wichtigste, was stört, und prüfe das Ergebnis.","fr":"Je changerai le principal problème et vérifierai le résultat."},"c":{"ru":"Перестрою всё постепенно, чтобы не создать новых проблем.","en":"I’ll rebuild it gradually to avoid creating new problems.","es":"Lo reorganizaré poco a poco para no crear nuevos problemas.","pt":"Vou reorganizar tudo aos poucos para não criar novos problemas.","de":"Ich stelle es schrittweise um, damit keine neuen Probleme entstehen.","fr":"Je réorganiserai progressivement pour ne pas créer de nouveaux problèmes."},"stats":{"a":49,"b":38,"c":13},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какую музыку ты включишь, чтобы быстро изменить настроение Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which music would you play to quickly change your mood What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué música pondrías para cambiar rápidamente de ánimo ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que música colocaria para mudar rapidamente de humor O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welche Musik würdest du einschalten, um deine Stimmung schnell zu verändern Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quelle musique écouterais-tu pour changer rapidement d’humeur Que feras-tu dans cette situation ?"},"a":{"ru":"Скажу прямо, что думаю, и предложу решение.","en":"I’ll say what I think directly and suggest a solution.","es":"Diré directamente lo que pienso y propondré una solución.","pt":"Vou dizer diretamente o que penso e propor uma solução.","de":"Ich sage direkt, was ich denke, und schlage eine Lösung vor.","fr":"Je dirai directement ce que je pense et proposerai une solution."},"b":{"ru":"Сначала задам вопросы и соберу больше информации.","en":"I’ll ask questions first and gather more information.","es":"Primero haré preguntas y reuniré más información.","pt":"Primeiro farei perguntas e recolherei mais informação.","de":"Ich stelle zuerst Fragen und sammle mehr Informationen.","fr":"Je poserai d’abord des questions et recueillerai plus d’informations."},"c":{"ru":"Не буду давить и вернусь к теме, когда момент станет подходящим.","en":"I won’t push and will return to it when the timing is right.","es":"No presionaré y volveré al tema cuando sea el momento adecuado.","pt":"Não vou pressionar e voltarei ao assunto quando for o momento certo.","de":"Ich übe keinen Druck aus und komme später darauf zurück.","fr":"Je ne mettrai pas la pression et j’y reviendrai au bon moment."},"stats":{"a":62,"b":24,"c":14},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что тебе важнее в любимой песне Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What matters most to you in a favorite song What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué valoras más en una canción favorita ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que é mais importante para você em uma música favorita O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was ist dir in einem Lieblingslied am wichtigsten Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Qu’est-ce qui compte le plus dans une chanson que tu aimes Que feras-tu dans cette situation ?"},"a":{"ru":"Скажу прямо, что думаю, и предложу решение.","en":"I’ll say what I think directly and suggest a solution.","es":"Diré directamente lo que pienso y propondré una solución.","pt":"Vou dizer diretamente o que penso e propor uma solução.","de":"Ich sage direkt, was ich denke, und schlage eine Lösung vor.","fr":"Je dirai directement ce que je pense et proposerai une solution."},"b":{"ru":"Сначала задам вопросы и соберу больше информации.","en":"I’ll ask questions first and gather more information.","es":"Primero haré preguntas y reuniré más información.","pt":"Primeiro farei perguntas e recolherei mais informação.","de":"Ich stelle zuerst Fragen und sammle mehr Informationen.","fr":"Je poserai d’abord des questions et recueillerai plus d’informations."},"c":{"ru":"Не буду давить и вернусь к теме, когда момент станет подходящим.","en":"I won’t push and will return to it when the timing is right.","es":"No presionaré y volveré al tema cuando sea el momento adecuado.","pt":"Não vou pressionar e voltarei ao assunto quando for o momento certo.","de":"Ich übe keinen Druck aus und komme später darauf zurück.","fr":"Je ne mettrai pas la pression et j’y reviendrai au bon moment."},"stats":{"a":42,"b":35,"c":23},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Как ты выбираешь новый альбом для прослушивания Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. How do you choose a new album to listen to What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Cómo eliges un álbum nuevo para escuchar ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Como escolhe um álbum novo para ouvir O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Wie wählst du ein neues Album zum Anhören aus Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Comment choisis-tu un nouvel album à écouter Que feras-tu dans cette situation ?"},"a":{"ru":"Скажу прямо, что думаю, и предложу решение.","en":"I’ll say what I think directly and suggest a solution.","es":"Diré directamente lo que pienso y propondré una solución.","pt":"Vou dizer diretamente o que penso e propor uma solução.","de":"Ich sage direkt, was ich denke, und schlage eine Lösung vor.","fr":"Je dirai directement ce que je pense et proposerai une solution."},"b":{"ru":"Сначала задам вопросы и соберу больше информации.","en":"I’ll ask questions first and gather more information.","es":"Primero haré preguntas y reuniré más información.","pt":"Primeiro farei perguntas e recolherei mais informação.","de":"Ich stelle zuerst Fragen und sammle mehr Informationen.","fr":"Je poserai d’abord des questions et recueillerai plus d’informations."},"c":{"ru":"Не буду давить и вернусь к теме, когда момент станет подходящим.","en":"I won’t push and will return to it when the timing is right.","es":"No presionaré y volveré al tema cuando sea el momento adecuado.","pt":"Não vou pressionar e voltarei ao assunto quando for o momento certo.","de":"Ich übe keinen Druck aus und komme später darauf zurück.","fr":"Je ne mettrai pas la pression et j’y reviendrai au bon moment."},"stats":{"a":43,"b":46,"c":11},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой звук ты бы добавил к идеальному утру Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which sound would you add to a perfect morning What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué sonido añadirías a una mañana perfecta ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que som acrescentaria a uma manhã perfeita O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welches Geräusch würdest du zu einem perfekten Morgen hinzufügen Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel son ajouterais-tu à un matin parfait Que feras-tu dans cette situation ?"},"a":{"ru":"Скажу прямо, что думаю, и предложу решение.","en":"I’ll say what I think directly and suggest a solution.","es":"Diré directamente lo que pienso y propondré una solución.","pt":"Vou dizer diretamente o que penso e propor uma solução.","de":"Ich sage direkt, was ich denke, und schlage eine Lösung vor.","fr":"Je dirai directement ce que je pense et proposerai une solution."},"b":{"ru":"Сначала задам вопросы и соберу больше информации.","en":"I’ll ask questions first and gather more information.","es":"Primero haré preguntas y reuniré más información.","pt":"Primeiro farei perguntas e recolherei mais informação.","de":"Ich stelle zuerst Fragen und sammle mehr Informationen.","fr":"Je poserai d’abord des questions et recueillerai plus d’informations."},"c":{"ru":"Не буду давить и вернусь к теме, когда момент станет подходящим.","en":"I won’t push and will return to it when the timing is right.","es":"No presionaré y volveré al tema cuando sea el momento adecuado.","pt":"Não vou pressionar e voltarei ao assunto quando for o momento certo.","de":"Ich übe keinen Druck aus und komme später darauf zurück.","fr":"Je ne mettrai pas la pression et j’y reviendrai au bon moment."},"stats":{"a":56,"b":32,"c":12},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что ты предпочитаешь на фоне долгой работы Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What do you prefer to have in the background during a long work session What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué prefieres escuchar de fondo durante mucho trabajo ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que prefere ouvir ao fundo durante um longo trabalho O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was hörst du bei langer Arbeit am liebsten im Hintergrund Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Que préfères-tu écouter en fond pendant un long travail Que feras-tu dans cette situation ?"},"a":{"ru":"Скажу прямо, что думаю, и предложу решение.","en":"I’ll say what I think directly and suggest a solution.","es":"Diré directamente lo que pienso y propondré una solución.","pt":"Vou dizer diretamente o que penso e propor uma solução.","de":"Ich sage direkt, was ich denke, und schlage eine Lösung vor.","fr":"Je dirai directement ce que je pense et proposerai une solution."},"b":{"ru":"Сначала задам вопросы и соберу больше информации.","en":"I’ll ask questions first and gather more information.","es":"Primero haré preguntas y reuniré más información.","pt":"Primeiro farei perguntas e recolherei mais informação.","de":"Ich stelle zuerst Fragen und sammle mehr Informationen.","fr":"Je poserai d’abord des questions et recueillerai plus d’informations."},"c":{"ru":"Не буду давить и вернусь к теме, когда момент станет подходящим.","en":"I won’t push and will return to it when the timing is right.","es":"No presionaré y volveré al tema cuando sea el momento adecuado.","pt":"Não vou pressionar e voltarei ao assunto quando for o momento certo.","de":"Ich übe keinen Druck aus und komme später darauf zurück.","fr":"Je ne mettrai pas la pression et j’y reviendrai au bon moment."},"stats":{"a":36,"b":43,"c":21},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой городской объект тебе интереснее рассматривать вечером Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which city object is most interesting to look at in the evening What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué objeto urbano te interesa más observar por la noche ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que objeto da cidade é mais interessante observar à noite O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welches städtische Objekt findest du abends am interessantesten Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel élément de la ville trouves-tu le plus intéressant à regarder le soir Que feras-tu dans cette situation ?"},"a":{"ru":"Скажу прямо, что думаю, и предложу решение.","en":"I’ll say what I think directly and suggest a solution.","es":"Diré directamente lo que pienso y propondré una solución.","pt":"Vou dizer diretamente o que penso e propor uma solução.","de":"Ich sage direkt, was ich denke, und schlage eine Lösung vor.","fr":"Je dirai directement ce que je pense et proposerai une solution."},"b":{"ru":"Сначала задам вопросы и соберу больше информации.","en":"I’ll ask questions first and gather more information.","es":"Primero haré preguntas y reuniré más información.","pt":"Primeiro farei perguntas e recolherei mais informação.","de":"Ich stelle zuerst Fragen und sammle mehr Informationen.","fr":"Je poserai d’abord des questions et recueillerai plus d’informations."},"c":{"ru":"Не буду давить и вернусь к теме, когда момент станет подходящим.","en":"I won’t push and will return to it when the timing is right.","es":"No presionaré y volveré al tema cuando sea el momento adecuado.","pt":"Não vou pressionar e voltarei ao assunto quando for o momento certo.","de":"Ich übe keinen Druck aus und komme später darauf zurück.","fr":"Je ne mettrai pas la pression et j’y reviendrai au bon moment."},"stats":{"a":43,"b":29,"c":28},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что ты замечаешь, когда впервые приезжаешь в новый район Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What do you notice when you first arrive in a new neighborhood What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué notas al llegar por primera vez a un barrio nuevo ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que você percebe ao chegar pela primeira vez a um bairro novo O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was bemerkst du, wenn du zum ersten Mal in einem neuen Viertel ankommst Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Que remarques-tu lorsque tu arrives pour la première fois dans un nouveau quartier Que feras-tu dans cette situation ?"},"a":{"ru":"Скажу прямо, что думаю, и предложу решение.","en":"I’ll say what I think directly and suggest a solution.","es":"Diré directamente lo que pienso y propondré una solución.","pt":"Vou dizer diretamente o que penso e propor uma solução.","de":"Ich sage direkt, was ich denke, und schlage eine Lösung vor.","fr":"Je dirai directement ce que je pense et proposerai une solution."},"b":{"ru":"Сначала задам вопросы и соберу больше информации.","en":"I’ll ask questions first and gather more information.","es":"Primero haré preguntas y reuniré más información.","pt":"Primeiro farei perguntas e recolherei mais informação.","de":"Ich stelle zuerst Fragen und sammle mehr Informationen.","fr":"Je poserai d’abord des questions et recueillerai plus d’informations."},"c":{"ru":"Не буду давить и вернусь к теме, когда момент станет подходящим.","en":"I won’t push and will return to it when the timing is right.","es":"No presionaré y volveré al tema cuando sea el momento adecuado.","pt":"Não vou pressionar e voltarei ao assunto quando for o momento certo.","de":"Ich übe keinen Druck aus und komme später darauf zurück.","fr":"Je ne mettrai pas la pression et j’y reviendrai au bon moment."},"stats":{"a":44,"b":40,"c":16},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какое место в городе ты бы выбрал для долгого разговора Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which place in a city would you choose for a long conversation What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Dónde elegirías tener una conversación larga en la ciudad ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que lugar da cidade escolheria para uma conversa longa O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welchen Ort in der Stadt würdest du für ein langes Gespräch wählen Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel endroit de la ville choisirais-tu pour une longue conversation Que feras-tu dans cette situation ?"},"a":{"ru":"Скажу прямо, что думаю, и предложу решение.","en":"I’ll say what I think directly and suggest a solution.","es":"Diré directamente lo que pienso y propondré una solución.","pt":"Vou dizer diretamente o que penso e propor uma solução.","de":"Ich sage direkt, was ich denke, und schlage eine Lösung vor.","fr":"Je dirai directement ce que je pense et proposerai une solution."},"b":{"ru":"Сначала задам вопросы и соберу больше информации.","en":"I’ll ask questions first and gather more information.","es":"Primero haré preguntas y reuniré más información.","pt":"Primeiro farei perguntas e recolherei mais informação.","de":"Ich stelle zuerst Fragen und sammle mehr Informationen.","fr":"Je poserai d’abord des questions et recueillerai plus d’informations."},"c":{"ru":"Не буду давить и вернусь к теме, когда момент станет подходящим.","en":"I won’t push and will return to it when the timing is right.","es":"No presionaré y volveré al tema cuando sea el momento adecuado.","pt":"Não vou pressionar e voltarei ao assunto quando for o momento certo.","de":"Ich übe keinen Druck aus und komme später darauf zurück.","fr":"Je ne mettrai pas la pression et j’y reviendrai au bon moment."},"stats":{"a":57,"b":26,"c":17},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что делает район привлекательным для жизни Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What makes a neighborhood attractive for living What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué hace atractivo un barrio para vivir ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que torna um bairro atraente para morar O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was macht ein Viertel zum attraktiven Wohnort Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Qu’est-ce qui rend un quartier agréable pour y vivre Que feras-tu dans cette situation ?"},"a":{"ru":"Скажу прямо, что думаю, и предложу решение.","en":"I’ll say what I think directly and suggest a solution.","es":"Diré directamente lo que pienso y propondré una solución.","pt":"Vou dizer diretamente o que penso e propor uma solução.","de":"Ich sage direkt, was ich denke, und schlage eine Lösung vor.","fr":"Je dirai directement ce que je pense et proposerai une solution."},"b":{"ru":"Сначала задам вопросы и соберу больше информации.","en":"I’ll ask questions first and gather more information.","es":"Primero haré preguntas y reuniré más información.","pt":"Primeiro farei perguntas e recolherei mais informação.","de":"Ich stelle zuerst Fragen und sammle mehr Informationen.","fr":"Je poserai d’abord des questions et recueillerai plus d’informations."},"c":{"ru":"Не буду давить и вернусь к теме, когда момент станет подходящим.","en":"I won’t push and will return to it when the timing is right.","es":"No presionaré y volveré al tema cuando sea el momento adecuado.","pt":"Não vou pressionar e voltarei ao assunto quando for o momento certo.","de":"Ich übe keinen Druck aus und komme später darauf zurück.","fr":"Je ne mettrai pas la pression et j’y reviendrai au bon moment."},"stats":{"a":37,"b":37,"c":26},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой элемент городской архитектуры тебе нравится больше всего Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which element of city architecture do you like most What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué elemento de la arquitectura urbana te gusta más ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Qual elemento da arquitetura urbana você mais gosta O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welches Element der Stadtarchitektur gefällt dir am besten Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel élément de l’architecture urbaine préfères-tu Que feras-tu dans cette situation ?"},"a":{"ru":"Скажу прямо, что думаю, и предложу решение.","en":"I’ll say what I think directly and suggest a solution.","es":"Diré directamente lo que pienso y propondré una solución.","pt":"Vou dizer diretamente o que penso e propor uma solução.","de":"Ich sage direkt, was ich denke, und schlage eine Lösung vor.","fr":"Je dirai directement ce que je pense et proposerai une solution."},"b":{"ru":"Сначала задам вопросы и соберу больше информации.","en":"I’ll ask questions first and gather more information.","es":"Primero haré preguntas y reuniré más información.","pt":"Primeiro farei perguntas e recolherei mais informação.","de":"Ich stelle zuerst Fragen und sammle mehr Informationen.","fr":"Je poserai d’abord des questions et recueillerai plus d’informations."},"c":{"ru":"Не буду давить и вернусь к теме, когда момент станет подходящим.","en":"I won’t push and will return to it when the timing is right.","es":"No presionaré y volveré al tema cuando sea el momento adecuado.","pt":"Não vou pressionar e voltarei ao assunto quando for o momento certo.","de":"Ich übe keinen Druck aus und komme später darauf zurück.","fr":"Je ne mettrai pas la pression et j’y reviendrai au bon moment."},"stats":{"a":38,"b":48,"c":14},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какое место на природе тебе легче всего представить своим убежищем Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which place in nature could you most easily imagine as your refuge What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué lugar de la naturaleza imaginarías más fácilmente como refugio ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que lugar da natureza você imaginaria mais facilmente como refúgio O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welchen Ort in der Natur könntest du dir am ehesten als Rückzugsort vorstellen Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel endroit dans la nature pourrais-tu facilement imaginer comme refuge Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу знакомый вариант, который уже доказал свою надёжность.","en":"I’ll choose the familiar option that has already proven reliable.","es":"Elegiré la opción conocida que ya ha demostrado ser fiable.","pt":"Vou escolher a opção conhecida que já provou ser fiável.","de":"Ich wähle die vertraute Option, die sich bereits bewährt hat.","fr":"Je choisirai l’option familière qui a déjà fait ses preuves."},"b":{"ru":"Попробую новое решение, если риск выглядит разумным.","en":"I’ll try a new solution if the risk seems reasonable.","es":"Probaré una solución nueva si el riesgo parece razonable.","pt":"Vou experimentar uma solução nova se o risco parecer razoável.","de":"Ich probiere eine neue Lösung, wenn das Risiko vertretbar ist.","fr":"J’essaierai une nouvelle solution si le risque semble raisonnable."},"c":{"ru":"Сначала изучу опыт других, чтобы снизить риск ошибки.","en":"I’ll study other people’s experience first to reduce the risk of a mistake.","es":"Primero estudiaré la experiencia de otros para reducir el riesgo de error.","pt":"Primeiro analisarei a experiência de outras pessoas para reduzir o risco de erro.","de":"Ich schaue mir zuerst die Erfahrungen anderer an, um Fehler zu vermeiden.","fr":"J’étudierai d’abord l’expérience des autres pour réduire le risque d’erreur."},"stats":{"a":51,"b":34,"c":15},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что тебе приятнее делать у воды Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What do you enjoy doing most by the water What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué te gusta más hacer cerca del agua ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que você gosta mais de fazer perto da água O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was machst du am liebsten am Wasser Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Que préfères-tu faire près de l’eau Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу знакомый вариант, который уже доказал свою надёжность.","en":"I’ll choose the familiar option that has already proven reliable.","es":"Elegiré la opción conocida que ya ha demostrado ser fiable.","pt":"Vou escolher a opção conhecida que já provou ser fiável.","de":"Ich wähle die vertraute Option, die sich bereits bewährt hat.","fr":"Je choisirai l’option familière qui a déjà fait ses preuves."},"b":{"ru":"Попробую новое решение, если риск выглядит разумным.","en":"I’ll try a new solution if the risk seems reasonable.","es":"Probaré una solución nueva si el riesgo parece razonable.","pt":"Vou experimentar uma solução nova se o risco parecer razoável.","de":"Ich probiere eine neue Lösung, wenn das Risiko vertretbar ist.","fr":"J’essaierai une nouvelle solution si le risque semble raisonnable."},"c":{"ru":"Сначала изучу опыт других, чтобы снизить риск ошибки.","en":"I’ll study other people’s experience first to reduce the risk of a mistake.","es":"Primero estudiaré la experiencia de otros para reducir el riesgo de error.","pt":"Primeiro analisarei a experiência de outras pessoas para reduzir o risco de erro.","de":"Ich schaue mir zuerst die Erfahrungen anderer an, um Fehler zu vermeiden.","fr":"J’étudierai d’abord l’expérience des autres pour réduire le risque d’erreur."},"stats":{"a":52,"b":45,"c":3},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какую погоду ты считаешь идеальной для прогулки Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What weather do you consider ideal for a walk What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué clima consideras ideal para caminar ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que tempo considera ideal para caminhar O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welches Wetter ist für dich ideal zum Spazierengehen Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel temps trouves-tu idéal pour une promenade Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу знакомый вариант, который уже доказал свою надёжность.","en":"I’ll choose the familiar option that has already proven reliable.","es":"Elegiré la opción conocida que ya ha demostrado ser fiable.","pt":"Vou escolher a opção conhecida que já provou ser fiável.","de":"Ich wähle die vertraute Option, die sich bereits bewährt hat.","fr":"Je choisirai l’option familière qui a déjà fait ses preuves."},"b":{"ru":"Попробую новое решение, если риск выглядит разумным.","en":"I’ll try a new solution if the risk seems reasonable.","es":"Probaré una solución nueva si el riesgo parece razonable.","pt":"Vou experimentar uma solução nova se o risco parecer razoável.","de":"Ich probiere eine neue Lösung, wenn das Risiko vertretbar ist.","fr":"J’essaierai une nouvelle solution si le risque semble raisonnable."},"c":{"ru":"Сначала изучу опыт других, чтобы снизить риск ошибки.","en":"I’ll study other people’s experience first to reduce the risk of a mistake.","es":"Primero estudiaré la experiencia de otros para reducir el riesgo de error.","pt":"Primeiro analisarei a experiência de outras pessoas para reduzir o risco de erro.","de":"Ich schaue mir zuerst die Erfahrungen anderer an, um Fehler zu vermeiden.","fr":"J’étudierai d’abord l’expérience des autres pour réduire le risque d’erreur."},"stats":{"a":38,"b":31,"c":31},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что сильнее всего притягивает тебя в лесу Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What attracts you most strongly in a forest What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué te atrae más de un bosque ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que mais atrai você em uma floresta O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was zieht dich im Wald am stärksten an Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Qu’est-ce qui t’attire le plus dans une forêt Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу знакомый вариант, который уже доказал свою надёжность.","en":"I’ll choose the familiar option that has already proven reliable.","es":"Elegiré la opción conocida que ya ha demostrado ser fiable.","pt":"Vou escolher a opção conhecida que já provou ser fiável.","de":"Ich wähle die vertraute Option, die sich bereits bewährt hat.","fr":"Je choisirai l’option familière qui a déjà fait ses preuves."},"b":{"ru":"Попробую новое решение, если риск выглядит разумным.","en":"I’ll try a new solution if the risk seems reasonable.","es":"Probaré una solución nueva si el riesgo parece razonable.","pt":"Vou experimentar uma solução nova se o risco parecer razoável.","de":"Ich probiere eine neue Lösung, wenn das Risiko vertretbar ist.","fr":"J’essaierai une nouvelle solution si le risque semble raisonnable."},"c":{"ru":"Сначала изучу опыт других, чтобы снизить риск ошибки.","en":"I’ll study other people’s experience first to reduce the risk of a mistake.","es":"Primero estudiaré la experiencia de otros para reducir el riesgo de error.","pt":"Primeiro analisarei a experiência de outras pessoas para reduzir o risco de erro.","de":"Ich schaue mir zuerst die Erfahrungen anderer an, um Fehler zu vermeiden.","fr":"J’étudierai d’abord l’expérience des autres pour réduire le risque d’erreur."},"stats":{"a":45,"b":42,"c":13},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой природный пейзаж ты бы хотел увидеть лично Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which natural landscape would you like to see in person What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué paisaje natural te gustaría ver en persona ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que paisagem natural gostaria de ver pessoalmente O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welche Landschaft der Natur würdest du gern persönlich sehen Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel paysage naturel aimerais-tu voir de tes propres yeux Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу знакомый вариант, который уже доказал свою надёжность.","en":"I’ll choose the familiar option that has already proven reliable.","es":"Elegiré la opción conocida que ya ha demostrado ser fiable.","pt":"Vou escolher a opção conhecida que já provou ser fiável.","de":"Ich wähle die vertraute Option, die sich bereits bewährt hat.","fr":"Je choisirai l’option familière qui a déjà fait ses preuves."},"b":{"ru":"Попробую новое решение, если риск выглядит разумным.","en":"I’ll try a new solution if the risk seems reasonable.","es":"Probaré una solución nueva si el riesgo parece razonable.","pt":"Vou experimentar uma solução nova se o risco parecer razoável.","de":"Ich probiere eine neue Lösung, wenn das Risiko vertretbar ist.","fr":"J’essaierai une nouvelle solution si le risque semble raisonnable."},"c":{"ru":"Сначала изучу опыт других, чтобы снизить риск ошибки.","en":"I’ll study other people’s experience first to reduce the risk of a mistake.","es":"Primero estudiaré la experiencia de otros para reducir el riesgo de error.","pt":"Primeiro analisarei a experiência de outras pessoas para reduzir o risco de erro.","de":"Ich schaue mir zuerst die Erfahrungen anderer an, um Fehler zu vermeiden.","fr":"J’étudierai d’abord l’expérience des autres pour réduire le risque d’erreur."},"stats":{"a":52,"b":28,"c":20},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Как тебе легче всего запоминать новую информацию Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. How do you learn new information most easily What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Cómo te resulta más fácil recordar información nueva ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Como é mais fácil para você memorizar novas informações O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Wie kannst du dir neue Informationen am leichtesten merken Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Comment mémorises-tu le plus facilement de nouvelles informations Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу знакомый вариант, который уже доказал свою надёжность.","en":"I’ll choose the familiar option that has already proven reliable.","es":"Elegiré la opción conocida que ya ha demostrado ser fiable.","pt":"Vou escolher a opção conhecida que já provou ser fiável.","de":"Ich wähle die vertraute Option, die sich bereits bewährt hat.","fr":"Je choisirai l’option familière qui a déjà fait ses preuves."},"b":{"ru":"Попробую новое решение, если риск выглядит разумным.","en":"I’ll try a new solution if the risk seems reasonable.","es":"Probaré una solución nueva si el riesgo parece razonable.","pt":"Vou experimentar uma solução nova se o risco parecer razoável.","de":"Ich probiere eine neue Lösung, wenn das Risiko vertretbar ist.","fr":"J’essaierai une nouvelle solution si le risque semble raisonnable."},"c":{"ru":"Сначала изучу опыт других, чтобы снизить риск ошибки.","en":"I’ll study other people’s experience first to reduce the risk of a mistake.","es":"Primero estudiaré la experiencia de otros para reducir el riesgo de error.","pt":"Primeiro analisarei a experiência de outras pessoas para reduzir o risco de erro.","de":"Ich schaue mir zuerst die Erfahrungen anderer an, um Fehler zu vermeiden.","fr":"J’étudierai d’abord l’expérience des autres pour réduire le risque d’erreur."},"stats":{"a":53,"b":39,"c":8},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что ты делаешь, когда тема кажется слишком сложной Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What do you do when a topic seems too difficult What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué haces cuando un tema parece demasiado difícil ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que faz quando um assunto parece difícil demais O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was machst du, wenn ein Thema zu schwierig erscheint Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Que fais-tu lorsqu’un sujet semble trop difficile Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу знакомый вариант, который уже доказал свою надёжность.","en":"I’ll choose the familiar option that has already proven reliable.","es":"Elegiré la opción conocida que ya ha demostrado ser fiable.","pt":"Vou escolher a opção conhecida que já provou ser fiável.","de":"Ich wähle die vertraute Option, die sich bereits bewährt hat.","fr":"Je choisirai l’option familière qui a déjà fait ses preuves."},"b":{"ru":"Попробую новое решение, если риск выглядит разумным.","en":"I’ll try a new solution if the risk seems reasonable.","es":"Probaré una solución nueva si el riesgo parece razonable.","pt":"Vou experimentar uma solução nova se o risco parecer razoável.","de":"Ich probiere eine neue Lösung, wenn das Risiko vertretbar ist.","fr":"J’essaierai une nouvelle solution si le risque semble raisonnable."},"c":{"ru":"Сначала изучу опыт других, чтобы снизить риск ошибки.","en":"I’ll study other people’s experience first to reduce the risk of a mistake.","es":"Primero estudiaré la experiencia de otros para reducir el riesgo de error.","pt":"Primeiro analisarei a experiência de outras pessoas para reduzir o risco de erro.","de":"Ich schaue mir zuerst die Erfahrungen anderer an, um Fehler zu vermeiden.","fr":"J’étudierai d’abord l’expérience des autres pour réduire le risque d’erreur."},"stats":{"a":39,"b":25,"c":36},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой новый навык ты бы выбрал для ближайших месяцев Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which new skill would you choose for the coming months What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué habilidad nueva elegirías para los próximos meses ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que nova habilidade escolheria para os próximos meses O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welche neue Fähigkeit würdest du für die nächsten Monate wählen Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quelle nouvelle compétence choisirais-tu pour les prochains mois Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу знакомый вариант, который уже доказал свою надёжность.","en":"I’ll choose the familiar option that has already proven reliable.","es":"Elegiré la opción conocida que ya ha demostrado ser fiable.","pt":"Vou escolher a opção conhecida que já provou ser fiável.","de":"Ich wähle die vertraute Option, die sich bereits bewährt hat.","fr":"Je choisirai l’option familière qui a déjà fait ses preuves."},"b":{"ru":"Попробую новое решение, если риск выглядит разумным.","en":"I’ll try a new solution if the risk seems reasonable.","es":"Probaré una solución nueva si el riesgo parece razonable.","pt":"Vou experimentar uma solução nova se o risco parecer razoável.","de":"Ich probiere eine neue Lösung, wenn das Risiko vertretbar ist.","fr":"J’essaierai une nouvelle solution si le risque semble raisonnable."},"c":{"ru":"Сначала изучу опыт других, чтобы снизить риск ошибки.","en":"I’ll study other people’s experience first to reduce the risk of a mistake.","es":"Primero estudiaré la experiencia de otros para reducir el riesgo de error.","pt":"Primeiro analisarei a experiência de outras pessoas para reduzir o risco de erro.","de":"Ich schaue mir zuerst die Erfahrungen anderer an, um Fehler zu vermeiden.","fr":"J’étudierai d’abord l’expérience des autres pour réduire le risque d’erreur."},"stats":{"a":46,"b":36,"c":18},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что помогает тебе не бросить обучение на середине Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What helps you avoid quitting your studies halfway through What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué te ayuda a no abandonar el estudio a mitad de camino ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que ajuda você a não abandonar os estudos pela metade O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was hilft dir, das Lernen nicht auf halbem Weg aufzugeben Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Qu’est-ce qui t’aide à ne pas abandonner tes études en cours de route Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу знакомый вариант, который уже доказал свою надёжность.","en":"I’ll choose the familiar option that has already proven reliable.","es":"Elegiré la opción conocida que ya ha demostrado ser fiable.","pt":"Vou escolher a opção conhecida que já provou ser fiável.","de":"Ich wähle die vertraute Option, die sich bereits bewährt hat.","fr":"Je choisirai l’option familière qui a déjà fait ses preuves."},"b":{"ru":"Попробую новое решение, если риск выглядит разумным.","en":"I’ll try a new solution if the risk seems reasonable.","es":"Probaré una solución nueva si el riesgo parece razonable.","pt":"Vou experimentar uma solução nova se o risco parecer razoável.","de":"Ich probiere eine neue Lösung, wenn das Risiko vertretbar ist.","fr":"J’essaierai une nouvelle solution si le risque semble raisonnable."},"c":{"ru":"Сначала изучу опыт других, чтобы снизить риск ошибки.","en":"I’ll study other people’s experience first to reduce the risk of a mistake.","es":"Primero estudiaré la experiencia de otros para reducir el riesgo de error.","pt":"Primeiro analisarei a experiência de outras pessoas para reduzir o risco de erro.","de":"Ich schaue mir zuerst die Erfahrungen anderer an, um Fehler zu vermeiden.","fr":"J’étudierai d’abord l’expérience des autres pour réduire le risque d’erreur."},"stats":{"a":47,"b":47,"c":6},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой способ объяснения материала тебе понятнее Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which way of explaining material is clearest to you What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué forma de explicar un tema te resulta más clara ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que forma de explicar um conteúdo é mais clara para você O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welche Art der Erklärung eines Themas ist für dich am verständlichsten Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quelle manière d’expliquer une matière est la plus claire pour toi Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу знакомый вариант, который уже доказал свою надёжность.","en":"I’ll choose the familiar option that has already proven reliable.","es":"Elegiré la opción conocida que ya ha demostrado ser fiable.","pt":"Vou escolher a opção conhecida que já provou ser fiável.","de":"Ich wähle die vertraute Option, die sich bereits bewährt hat.","fr":"Je choisirai l’option familière qui a déjà fait ses preuves."},"b":{"ru":"Попробую новое решение, если риск выглядит разумным.","en":"I’ll try a new solution if the risk seems reasonable.","es":"Probaré una solución nueva si el riesgo parece razonable.","pt":"Vou experimentar uma solução nova se o risco parecer razoável.","de":"Ich probiere eine neue Lösung, wenn das Risiko vertretbar ist.","fr":"J’essaierai une nouvelle solution si le risque semble raisonnable."},"c":{"ru":"Сначала изучу опыт других, чтобы снизить риск ошибки.","en":"I’ll study other people’s experience first to reduce the risk of a mistake.","es":"Primero estudiaré la experiencia de otros para reducir el riesgo de error.","pt":"Primeiro analisarei a experiência de outras pessoas para reduzir o risco de erro.","de":"Ich schaue mir zuerst die Erfahrungen anderer an, um Fehler zu vermeiden.","fr":"J’étudierai d’abord l’expérience des autres pour réduire le risque d’erreur."},"stats":{"a":54,"b":33,"c":13},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какое устройство ты бы заменил в первую очередь при ограниченном бюджете Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which device would you replace first on a limited budget What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué dispositivo cambiarías primero con un presupuesto limitado ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Qual dispositivo substituiria primeiro com orçamento limitado O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welches Gerät würdest du bei begrenztem Budget zuerst ersetzen Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel appareil remplacerais-tu en premier avec un budget limité Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу отдых, который быстрее всего вернёт силы.","en":"I’ll choose the kind of rest that restores my energy fastest.","es":"Elegiré el descanso que me ayude a recuperar fuerzas más rápido.","pt":"Vou escolher o descanso que me devolva energia mais depressa.","de":"Ich wähle die Erholung, die mir am schnellsten neue Kraft gibt.","fr":"Je choisirai le repos qui me redonnera le plus vite de l’énergie."},"b":{"ru":"Сделаю то, чего хочется именно сегодня, даже если план изменится.","en":"I’ll do what I feel like today, even if the plan changes.","es":"Haré lo que me apetezca hoy, aunque cambie el plan.","pt":"Vou fazer o que me apetecer hoje, mesmo que o plano mude.","de":"Ich mache heute, worauf ich Lust habe, auch wenn sich der Plan ändert.","fr":"Je ferai ce dont j’ai envie aujourd’hui, même si le plan change."},"c":{"ru":"Заранее уберу лишние дела и освобожу время для отдыха.","en":"I’ll clear unnecessary tasks and deliberately make time to rest.","es":"Eliminaré tareas innecesarias y reservaré tiempo para descansar.","pt":"Vou eliminar tarefas desnecessárias e reservar tempo para descansar.","de":"Ich streiche unnötige Aufgaben und plane bewusst Zeit für Erholung ein.","fr":"Je supprimerai les tâches inutiles et réserverai du temps pour me reposer."},"stats":{"a":40,"b":44,"c":16},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что для тебя важнее в новом приложении Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What matters most to you in a new app What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué es lo más importante para ti en una aplicación nueva ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que é mais importante para você em um aplicativo novo O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was ist dir bei einer neuen App am wichtigsten Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Qu’est-ce qui compte le plus pour toi dans une nouvelle application Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу отдых, который быстрее всего вернёт силы.","en":"I’ll choose the kind of rest that restores my energy fastest.","es":"Elegiré el descanso que me ayude a recuperar fuerzas más rápido.","pt":"Vou escolher o descanso que me devolva energia mais depressa.","de":"Ich wähle die Erholung, die mir am schnellsten neue Kraft gibt.","fr":"Je choisirai le repos qui me redonnera le plus vite de l’énergie."},"b":{"ru":"Сделаю то, чего хочется именно сегодня, даже если план изменится.","en":"I’ll do what I feel like today, even if the plan changes.","es":"Haré lo que me apetezca hoy, aunque cambie el plan.","pt":"Vou fazer o que me apetecer hoje, mesmo que o plano mude.","de":"Ich mache heute, worauf ich Lust habe, auch wenn sich der Plan ändert.","fr":"Je ferai ce dont j’ai envie aujourd’hui, même si le plan change."},"c":{"ru":"Заранее уберу лишние дела и освобожу время для отдыха.","en":"I’ll clear unnecessary tasks and deliberately make time to rest.","es":"Eliminaré tareas innecesarias y reservaré tiempo para descansar.","pt":"Vou eliminar tarefas desnecessárias e reservar tempo para descansar.","de":"Ich streiche unnötige Aufgaben und plane bewusst Zeit für Erholung ein.","fr":"Je supprimerai les tâches inutiles et réserverai du temps pour me reposer."},"stats":{"a":47,"b":30,"c":23},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Как ты относишься к автоматизации повседневных дел Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. How do you feel about automating everyday tasks What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Cómo ves la automatización de las tareas diarias ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Como vê a automação das tarefas do dia a dia O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Wie stehst du zur Automatisierung alltäglicher Aufgaben Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Que penses-tu de l’automatisation des tâches quotidiennes Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу отдых, который быстрее всего вернёт силы.","en":"I’ll choose the kind of rest that restores my energy fastest.","es":"Elegiré el descanso que me ayude a recuperar fuerzas más rápido.","pt":"Vou escolher o descanso que me devolva energia mais depressa.","de":"Ich wähle die Erholung, die mir am schnellsten neue Kraft gibt.","fr":"Je choisirai le repos qui me redonnera le plus vite de l’énergie."},"b":{"ru":"Сделаю то, чего хочется именно сегодня, даже если план изменится.","en":"I’ll do what I feel like today, even if the plan changes.","es":"Haré lo que me apetezca hoy, aunque cambie el plan.","pt":"Vou fazer o que me apetecer hoje, mesmo que o plano mude.","de":"Ich mache heute, worauf ich Lust habe, auch wenn sich der Plan ändert.","fr":"Je ferai ce dont j’ai envie aujourd’hui, même si le plan change."},"c":{"ru":"Заранее уберу лишние дела и освобожу время для отдыха.","en":"I’ll clear unnecessary tasks and deliberately make time to rest.","es":"Eliminaré tareas innecesarias y reservaré tiempo para descansar.","pt":"Vou eliminar tarefas desnecessárias e reservar tempo para descansar.","de":"Ich streiche unnötige Aufgaben und plane bewusst Zeit für Erholung ein.","fr":"Je supprimerai les tâches inutiles et réserverai du temps pour me reposer."},"stats":{"a":48,"b":41,"c":11},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какую цифровую привычку тебе хотелось бы изменить Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which digital habit would you like to change What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué hábito digital te gustaría cambiar ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que hábito digital gostaria de mudar O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welche digitale Gewohnheit würdest du gern ändern Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quelle habitude numérique aimerais-tu changer Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу отдых, который быстрее всего вернёт силы.","en":"I’ll choose the kind of rest that restores my energy fastest.","es":"Elegiré el descanso que me ayude a recuperar fuerzas más rápido.","pt":"Vou escolher o descanso que me devolva energia mais depressa.","de":"Ich wähle die Erholung, die mir am schnellsten neue Kraft gibt.","fr":"Je choisirai le repos qui me redonnera le plus vite de l’énergie."},"b":{"ru":"Сделаю то, чего хочется именно сегодня, даже если план изменится.","en":"I’ll do what I feel like today, even if the plan changes.","es":"Haré lo que me apetezca hoy, aunque cambie el plan.","pt":"Vou fazer o que me apetecer hoje, mesmo que o plano mude.","de":"Ich mache heute, worauf ich Lust habe, auch wenn sich der Plan ändert.","fr":"Je ferai ce dont j’ai envie aujourd’hui, même si le plan change."},"c":{"ru":"Заранее уберу лишние дела и освобожу время для отдыха.","en":"I’ll clear unnecessary tasks and deliberately make time to rest.","es":"Eliminaré tareas innecesarias y reservaré tiempo para descansar.","pt":"Vou eliminar tarefas desnecessárias e reservar tempo para descansar.","de":"Ich streiche unnötige Aufgaben und plane bewusst Zeit für Erholung ein.","fr":"Je supprimerai les tâches inutiles et réserverai du temps pour me reposer."},"stats":{"a":61,"b":27,"c":12},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что ты проверяешь перед установкой неизвестного приложения Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What do you check before installing an unfamiliar app What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué compruebas antes de instalar una aplicación desconocida ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que verifica antes de instalar um aplicativo desconhecido O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was prüfst du vor der Installation einer unbekannten App Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Que vérifies-tu avant d’installer une application inconnue Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу отдых, который быстрее всего вернёт силы.","en":"I’ll choose the kind of rest that restores my energy fastest.","es":"Elegiré el descanso que me ayude a recuperar fuerzas más rápido.","pt":"Vou escolher o descanso que me devolva energia mais depressa.","de":"Ich wähle die Erholung, die mir am schnellsten neue Kraft gibt.","fr":"Je choisirai le repos qui me redonnera le plus vite de l’énergie."},"b":{"ru":"Сделаю то, чего хочется именно сегодня, даже если план изменится.","en":"I’ll do what I feel like today, even if the plan changes.","es":"Haré lo que me apetezca hoy, aunque cambie el plan.","pt":"Vou fazer o que me apetecer hoje, mesmo que o plano mude.","de":"Ich mache heute, worauf ich Lust habe, auch wenn sich der Plan ändert.","fr":"Je ferai ce dont j’ai envie aujourd’hui, même si le plan change."},"c":{"ru":"Заранее уберу лишние дела и освобожу время для отдыха.","en":"I’ll clear unnecessary tasks and deliberately make time to rest.","es":"Eliminaré tareas innecesarias y reservaré tiempo para descansar.","pt":"Vou eliminar tarefas desnecessárias e reservar tempo para descansar.","de":"Ich streiche unnötige Aufgaben und plane bewusst Zeit für Erholung ein.","fr":"Je supprimerai les tâches inutiles et réserverai du temps pour me reposer."},"stats":{"a":41,"b":38,"c":21},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что помогает тебе понять незнакомого человека Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What helps you understand an unfamiliar person What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué te ayuda a comprender a una persona desconocida ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que ajuda você a entender uma pessoa desconhecida O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was hilft dir, einen unbekannten Menschen zu verstehen Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Qu’est-ce qui t’aide à comprendre une personne inconnue Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу отдых, который быстрее всего вернёт силы.","en":"I’ll choose the kind of rest that restores my energy fastest.","es":"Elegiré el descanso que me ayude a recuperar fuerzas más rápido.","pt":"Vou escolher o descanso que me devolva energia mais depressa.","de":"Ich wähle die Erholung, die mir am schnellsten neue Kraft gibt.","fr":"Je choisirai le repos qui me redonnera le plus vite de l’énergie."},"b":{"ru":"Сделаю то, чего хочется именно сегодня, даже если план изменится.","en":"I’ll do what I feel like today, even if the plan changes.","es":"Haré lo que me apetezca hoy, aunque cambie el plan.","pt":"Vou fazer o que me apetecer hoje, mesmo que o plano mude.","de":"Ich mache heute, worauf ich Lust habe, auch wenn sich der Plan ändert.","fr":"Je ferai ce dont j’ai envie aujourd’hui, même si le plan change."},"c":{"ru":"Заранее уберу лишние дела и освобожу время для отдыха.","en":"I’ll clear unnecessary tasks and deliberately make time to rest.","es":"Eliminaré tareas innecesarias y reservaré tiempo para descansar.","pt":"Vou eliminar tarefas desnecessárias e reservar tempo para descansar.","de":"Ich streiche unnötige Aufgaben und plane bewusst Zeit für Erholung ein.","fr":"Je supprimerai les tâches inutiles et réserverai du temps pour me reposer."},"stats":{"a":48,"b":24,"c":28},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой разговор ты считаешь действительно интересным Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What kind of conversation do you find truly interesting What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué tipo de conversación te parece realmente interesante ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que tipo de conversa considera realmente interessante O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welche Art von Gespräch findest du wirklich interessant Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel type de conversation trouves-tu vraiment intéressant Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу отдых, который быстрее всего вернёт силы.","en":"I’ll choose the kind of rest that restores my energy fastest.","es":"Elegiré el descanso que me ayude a recuperar fuerzas más rápido.","pt":"Vou escolher o descanso que me devolva energia mais depressa.","de":"Ich wähle die Erholung, die mir am schnellsten neue Kraft gibt.","fr":"Je choisirai le repos qui me redonnera le plus vite de l’énergie."},"b":{"ru":"Сделаю то, чего хочется именно сегодня, даже если план изменится.","en":"I’ll do what I feel like today, even if the plan changes.","es":"Haré lo que me apetezca hoy, aunque cambie el plan.","pt":"Vou fazer o que me apetecer hoje, mesmo que o plano mude.","de":"Ich mache heute, worauf ich Lust habe, auch wenn sich der Plan ändert.","fr":"Je ferai ce dont j’ai envie aujourd’hui, même si le plan change."},"c":{"ru":"Заранее уберу лишние дела и освобожу время для отдыха.","en":"I’ll clear unnecessary tasks and deliberately make time to rest.","es":"Eliminaré tareas innecesarias y reservaré tiempo para descansar.","pt":"Vou eliminar tarefas desnecessárias e reservar tempo para descansar.","de":"Ich streiche unnötige Aufgaben und plane bewusst Zeit für Erholung ein.","fr":"Je supprimerai les tâches inutiles et réserverai du temps pour me reposer."},"stats":{"a":49,"b":35,"c":16},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что ты предпочитаешь делать, если собеседник сильно волнуется Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What do you prefer to do when the person you are speaking with is very nervous What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué prefieres hacer si tu interlocutor está muy nervioso ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que prefere fazer quando a pessoa com quem fala está muito nervosa O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was machst du lieber, wenn dein Gesprächspartner sehr nervös ist Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Que préfères-tu faire lorsque ton interlocuteur est très nerveux Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу отдых, который быстрее всего вернёт силы.","en":"I’ll choose the kind of rest that restores my energy fastest.","es":"Elegiré el descanso que me ayude a recuperar fuerzas más rápido.","pt":"Vou escolher o descanso que me devolva energia mais depressa.","de":"Ich wähle die Erholung, die mir am schnellsten neue Kraft gibt.","fr":"Je choisirai le repos qui me redonnera le plus vite de l’énergie."},"b":{"ru":"Сделаю то, чего хочется именно сегодня, даже если план изменится.","en":"I’ll do what I feel like today, even if the plan changes.","es":"Haré lo que me apetezca hoy, aunque cambie el plan.","pt":"Vou fazer o que me apetecer hoje, mesmo que o plano mude.","de":"Ich mache heute, worauf ich Lust habe, auch wenn sich der Plan ändert.","fr":"Je ferai ce dont j’ai envie aujourd’hui, même si le plan change."},"c":{"ru":"Заранее уберу лишние дела и освобожу время для отдыха.","en":"I’ll clear unnecessary tasks and deliberately make time to rest.","es":"Eliminaré tareas innecesarias y reservaré tiempo para descansar.","pt":"Vou eliminar tarefas desnecessárias e reservar tempo para descansar.","de":"Ich streiche unnötige Aufgaben und plane bewusst Zeit für Erholung ein.","fr":"Je supprimerai les tâches inutiles et réserverai du temps pour me reposer."},"stats":{"a":56,"b":46,"c":-2},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Как ты относишься к длинным голосовым сообщениям Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. How do you feel about long voice messages What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Cómo ves los mensajes de voz muy largos ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Como vê mensagens de voz muito longas O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Wie stehst du zu sehr langen Sprachnachrichten Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Que penses-tu des très longs messages vocaux Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу отдых, который быстрее всего вернёт силы.","en":"I’ll choose the kind of rest that restores my energy fastest.","es":"Elegiré el descanso que me ayude a recuperar fuerzas más rápido.","pt":"Vou escolher o descanso que me devolva energia mais depressa.","de":"Ich wähle die Erholung, die mir am schnellsten neue Kraft gibt.","fr":"Je choisirai le repos qui me redonnera le plus vite de l’énergie."},"b":{"ru":"Сделаю то, чего хочется именно сегодня, даже если план изменится.","en":"I’ll do what I feel like today, even if the plan changes.","es":"Haré lo que me apetezca hoy, aunque cambie el plan.","pt":"Vou fazer o que me apetecer hoje, mesmo que o plano mude.","de":"Ich mache heute, worauf ich Lust habe, auch wenn sich der Plan ändert.","fr":"Je ferai ce dont j’ai envie aujourd’hui, même si le plan change."},"c":{"ru":"Заранее уберу лишние дела и освобожу время для отдыха.","en":"I’ll clear unnecessary tasks and deliberately make time to rest.","es":"Eliminaré tareas innecesarias y reservaré tiempo para descansar.","pt":"Vou eliminar tarefas desnecessárias e reservar tempo para descansar.","de":"Ich streiche unnötige Aufgaben und plane bewusst Zeit für Erholung ein.","fr":"Je supprimerai les tâches inutiles et réserverai du temps pour me reposer."},"stats":{"a":42,"b":32,"c":26},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что тебе проще сказать лично, чем написать Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What is easier for you to say in person than to write What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué te resulta más fácil decir en persona que escribir ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que é mais fácil dizer pessoalmente do que escrever O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was fällt dir persönlich leichter zu sagen als zu schreiben Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Qu’est-ce qui est plus facile pour toi à dire en personne qu’à écrire Que feras-tu dans cette situation ?"},"a":{"ru":"Выберу отдых, который быстрее всего вернёт силы.","en":"I’ll choose the kind of rest that restores my energy fastest.","es":"Elegiré el descanso que me ayude a recuperar fuerzas más rápido.","pt":"Vou escolher o descanso que me devolva energia mais depressa.","de":"Ich wähle die Erholung, die mir am schnellsten neue Kraft gibt.","fr":"Je choisirai le repos qui me redonnera le plus vite de l’énergie."},"b":{"ru":"Сделаю то, чего хочется именно сегодня, даже если план изменится.","en":"I’ll do what I feel like today, even if the plan changes.","es":"Haré lo que me apetezca hoy, aunque cambie el plan.","pt":"Vou fazer o que me apetecer hoje, mesmo que o plano mude.","de":"Ich mache heute, worauf ich Lust habe, auch wenn sich der Plan ändert.","fr":"Je ferai ce dont j’ai envie aujourd’hui, même si le plan change."},"c":{"ru":"Заранее уберу лишние дела и освобожу время для отдыха.","en":"I’ll clear unnecessary tasks and deliberately make time to rest.","es":"Eliminaré tareas innecesarias y reservaré tiempo para descansar.","pt":"Vou eliminar tarefas desnecessárias e reservar tempo para descansar.","de":"Ich streiche unnötige Aufgaben und plane bewusst Zeit für Erholung ein.","fr":"Je supprimerai les tâches inutiles et réserverai du temps pour me reposer."},"stats":{"a":43,"b":43,"c":14},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что ты замечаешь в образе человека первым Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What do you notice first about a person’s appearance What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué notas primero en la apariencia de una persona ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que você nota primeiro na aparência de uma pessoa O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was fällt dir am Aussehen eines Menschen zuerst auf Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Que remarques-tu en premier dans l’apparence d’une personne Que feras-tu dans cette situation ?"},"a":{"ru":"Скажу правду сразу, даже если это будет неудобно.","en":"I’ll tell the truth immediately, even if it is uncomfortable.","es":"Diré la verdad de inmediato, aunque sea incómoda.","pt":"Vou dizer a verdade de imediato, mesmo que seja desconfortável.","de":"Ich sage sofort die Wahrheit, auch wenn sie unangenehm ist.","fr":"Je dirai la vérité tout de suite, même si elle est inconfortable."},"b":{"ru":"Сначала подберу спокойные слова, чтобы не ранить человека.","en":"I’ll choose calm words first so I don’t hurt the person.","es":"Primero elegiré palabras tranquilas para no herir a la otra persona.","pt":"Primeiro vou escolher palavras calmas para não magoar a pessoa.","de":"Ich wähle zuerst ruhige Worte, damit ich die Person nicht verletze.","fr":"Je choisirai d’abord des mots calmes pour ne pas blesser la personne."},"c":{"ru":"Скажу честно, но дам человеку время спокойно это осмыслить.","en":"I’ll be honest but give the person time to process it calmly.","es":"Seré sincero, pero dejaré que la persona lo procese con calma.","pt":"Vou ser honesto, mas darei tempo para a pessoa pensar com calma.","de":"Ich bin ehrlich, gebe der Person aber Zeit, darüber nachzudenken.","fr":"Je serai honnête, tout en laissant à la personne le temps de réfléchir calmement."},"stats":{"a":56,"b":29,"c":15},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой стиль одежды тебе кажется самым выразительным Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which clothing style seems the most expressive to you What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué estilo de ropa te parece más expresivo ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que estilo de roupa parece mais expressivo para você O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welcher Kleidungsstil wirkt auf dich am ausdrucksstärksten Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel style vestimentaire te semble le plus expressif Que feras-tu dans cette situation ?"},"a":{"ru":"Скажу правду сразу, даже если это будет неудобно.","en":"I’ll tell the truth immediately, even if it is uncomfortable.","es":"Diré la verdad de inmediato, aunque sea incómoda.","pt":"Vou dizer a verdade de imediato, mesmo que seja desconfortável.","de":"Ich sage sofort die Wahrheit, auch wenn sie unangenehm ist.","fr":"Je dirai la vérité tout de suite, même si elle est inconfortable."},"b":{"ru":"Сначала подберу спокойные слова, чтобы не ранить человека.","en":"I’ll choose calm words first so I don’t hurt the person.","es":"Primero elegiré palabras tranquilas para no herir a la otra persona.","pt":"Primeiro vou escolher palavras calmas para não magoar a pessoa.","de":"Ich wähle zuerst ruhige Worte, damit ich die Person nicht verletze.","fr":"Je choisirai d’abord des mots calmes pour ne pas blesser la personne."},"c":{"ru":"Скажу честно, но дам человеку время спокойно это осмыслить.","en":"I’ll be honest but give the person time to process it calmly.","es":"Seré sincero, pero dejaré que la persona lo procese con calma.","pt":"Vou ser honesto, mas darei tempo para a pessoa pensar com calma.","de":"Ich bin ehrlich, gebe der Person aber Zeit, darüber nachzudenken.","fr":"Je serai honnête, tout en laissant à la personne le temps de réfléchir calmement."},"stats":{"a":36,"b":40,"c":24},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что для тебя важнее при выборе новой вещи Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What matters most when choosing a new item of clothing What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué es más importante al elegir una prenda nueva ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que é mais importante ao escolher uma peça nova O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was ist dir bei der Wahl eines neuen Kleidungsstücks am wichtigsten Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Qu’est-ce qui compte le plus lorsque tu choisis un nouveau vêtement Que feras-tu dans cette situation ?"},"a":{"ru":"Скажу правду сразу, даже если это будет неудобно.","en":"I’ll tell the truth immediately, even if it is uncomfortable.","es":"Diré la verdad de inmediato, aunque sea incómoda.","pt":"Vou dizer a verdade de imediato, mesmo que seja desconfortável.","de":"Ich sage sofort die Wahrheit, auch wenn sie unangenehm ist.","fr":"Je dirai la vérité tout de suite, même si elle est inconfortable."},"b":{"ru":"Сначала подберу спокойные слова, чтобы не ранить человека.","en":"I’ll choose calm words first so I don’t hurt the person.","es":"Primero elegiré palabras tranquilas para no herir a la otra persona.","pt":"Primeiro vou escolher palavras calmas para não magoar a pessoa.","de":"Ich wähle zuerst ruhige Worte, damit ich die Person nicht verletze.","fr":"Je choisirai d’abord des mots calmes pour ne pas blesser la personne."},"c":{"ru":"Скажу честно, но дам человеку время спокойно это осмыслить.","en":"I’ll be honest but give the person time to process it calmly.","es":"Seré sincero, pero dejaré que la persona lo procese con calma.","pt":"Vou ser honesto, mas darei tempo para a pessoa pensar com calma.","de":"Ich bin ehrlich, gebe der Person aber Zeit, darüber nachzudenken.","fr":"Je serai honnête, tout en laissant à la personne le temps de réfléchir calmement."},"stats":{"a":43,"b":26,"c":31},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Как ты относишься к ярким необычным деталям в одежде Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. How do you feel about bright, unusual details in clothing What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Cómo ves los detalles de ropa llamativos y poco habituales ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Como vê detalhes de roupa chamativos e incomuns O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Wie findest du auffällige, ungewöhnliche Details in Kleidung Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Que penses-tu des détails vestimentaires très voyants et inhabituels Que feras-tu dans cette situation ?"},"a":{"ru":"Скажу правду сразу, даже если это будет неудобно.","en":"I’ll tell the truth immediately, even if it is uncomfortable.","es":"Diré la verdad de inmediato, aunque sea incómoda.","pt":"Vou dizer a verdade de imediato, mesmo que seja desconfortável.","de":"Ich sage sofort die Wahrheit, auch wenn sie unangenehm ist.","fr":"Je dirai la vérité tout de suite, même si elle est inconfortable."},"b":{"ru":"Сначала подберу спокойные слова, чтобы не ранить человека.","en":"I’ll choose calm words first so I don’t hurt the person.","es":"Primero elegiré palabras tranquilas para no herir a la otra persona.","pt":"Primeiro vou escolher palavras calmas para não magoar a pessoa.","de":"Ich wähle zuerst ruhige Worte, damit ich die Person nicht verletze.","fr":"Je choisirai d’abord des mots calmes pour ne pas blesser la personne."},"c":{"ru":"Скажу честно, но дам человеку время спокойно это осмыслить.","en":"I’ll be honest but give the person time to process it calmly.","es":"Seré sincero, pero dejaré que la persona lo procese con calma.","pt":"Vou ser honesto, mas darei tempo para a pessoa pensar com calma.","de":"Ich bin ehrlich, gebe der Person aber Zeit, darüber nachzudenken.","fr":"Je serai honnête, tout en laissant à la personne le temps de réfléchir calmement."},"stats":{"a":50,"b":37,"c":13},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой элемент образа способен полностью изменить впечатление Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which element of an outfit can completely change the impression What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué elemento de un conjunto puede cambiar por completo la impresión ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que elemento de um visual pode mudar totalmente a impressão O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welches Element eines Outfits kann den Eindruck völlig verändern Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel élément d’une tenue peut complètement changer l’impression Que feras-tu dans cette situation ?"},"a":{"ru":"Скажу правду сразу, даже если это будет неудобно.","en":"I’ll tell the truth immediately, even if it is uncomfortable.","es":"Diré la verdad de inmediato, aunque sea incómoda.","pt":"Vou dizer a verdade de imediato, mesmo que seja desconfortável.","de":"Ich sage sofort die Wahrheit, auch wenn sie unangenehm ist.","fr":"Je dirai la vérité tout de suite, même si elle est inconfortable."},"b":{"ru":"Сначала подберу спокойные слова, чтобы не ранить человека.","en":"I’ll choose calm words first so I don’t hurt the person.","es":"Primero elegiré palabras tranquilas para no herir a la otra persona.","pt":"Primeiro vou escolher palavras calmas para não magoar a pessoa.","de":"Ich wähle zuerst ruhige Worte, damit ich die Person nicht verletze.","fr":"Je choisirai d’abord des mots calmes pour ne pas blesser la personne."},"c":{"ru":"Скажу честно, но дам человеку время спокойно это осмыслить.","en":"I’ll be honest but give the person time to process it calmly.","es":"Seré sincero, pero dejaré que la persona lo procese con calma.","pt":"Vou ser honesto, mas darei tempo para a pessoa pensar com calma.","de":"Ich bin ehrlich, gebe der Person aber Zeit, darüber nachzudenken.","fr":"Je serai honnête, tout en laissant à la personne le temps de réfléchir calmement."},"stats":{"a":51,"b":48,"c":1},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой отдых действительно помогает тебе восстановиться Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What kind of rest really helps you recover What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué tipo de descanso te ayuda realmente a recuperarte ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que tipo de descanso realmente ajuda você a se recuperar O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welche Art von Erholung hilft dir wirklich, neue Kraft zu tanken Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel type de repos t’aide vraiment à récupérer Que feras-tu dans cette situation ?"},"a":{"ru":"Скажу правду сразу, даже если это будет неудобно.","en":"I’ll tell the truth immediately, even if it is uncomfortable.","es":"Diré la verdad de inmediato, aunque sea incómoda.","pt":"Vou dizer a verdade de imediato, mesmo que seja desconfortável.","de":"Ich sage sofort die Wahrheit, auch wenn sie unangenehm ist.","fr":"Je dirai la vérité tout de suite, même si elle est inconfortable."},"b":{"ru":"Сначала подберу спокойные слова, чтобы не ранить человека.","en":"I’ll choose calm words first so I don’t hurt the person.","es":"Primero elegiré palabras tranquilas para no herir a la otra persona.","pt":"Primeiro vou escolher palavras calmas para não magoar a pessoa.","de":"Ich wähle zuerst ruhige Worte, damit ich die Person nicht verletze.","fr":"Je choisirai d’abord des mots calmes pour ne pas blesser la personne."},"c":{"ru":"Скажу честно, но дам человеку время спокойно это осмыслить.","en":"I’ll be honest but give the person time to process it calmly.","es":"Seré sincero, pero dejaré que la persona lo procese con calma.","pt":"Vou ser honesto, mas darei tempo para a pessoa pensar com calma.","de":"Ich bin ehrlich, gebe der Person aber Zeit, darüber nachzudenken.","fr":"Je serai honnête, tout en laissant à la personne le temps de réfléchir calmement."},"stats":{"a":37,"b":34,"c":29},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что ты выберешь для вечера после насыщенного дня Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What would you choose for an evening after a busy day What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué elegirías para una noche después de un día intenso ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que escolheria para uma noite depois de um dia intenso O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was würdest du für einen Abend nach einem vollen Tag wählen Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Que choisirais-tu pour une soirée après une journée bien remplie Que feras-tu dans cette situation ?"},"a":{"ru":"Скажу правду сразу, даже если это будет неудобно.","en":"I’ll tell the truth immediately, even if it is uncomfortable.","es":"Diré la verdad de inmediato, aunque sea incómoda.","pt":"Vou dizer a verdade de imediato, mesmo que seja desconfortável.","de":"Ich sage sofort die Wahrheit, auch wenn sie unangenehm ist.","fr":"Je dirai la vérité tout de suite, même si elle est inconfortable."},"b":{"ru":"Сначала подберу спокойные слова, чтобы не ранить человека.","en":"I’ll choose calm words first so I don’t hurt the person.","es":"Primero elegiré palabras tranquilas para no herir a la otra persona.","pt":"Primeiro vou escolher palavras calmas para não magoar a pessoa.","de":"Ich wähle zuerst ruhige Worte, damit ich die Person nicht verletze.","fr":"Je choisirai d’abord des mots calmes pour ne pas blesser la personne."},"c":{"ru":"Скажу честно, но дам человеку время спокойно это осмыслить.","en":"I’ll be honest but give the person time to process it calmly.","es":"Seré sincero, pero dejaré que la persona lo procese con calma.","pt":"Vou ser honesto, mas darei tempo para a pessoa pensar com calma.","de":"Ich bin ehrlich, gebe der Person aber Zeit, darüber nachzudenken.","fr":"Je serai honnête, tout en laissant à la personne le temps de réfléchir calmement."},"stats":{"a":38,"b":45,"c":17},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой день недели тебе легче всего посвятить себе Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which day of the week is easiest for you to devote to yourself What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué día de la semana te resulta más fácil dedicarte a ti ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que dia da semana é mais fácil dedicar a si mesmo O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welcher Wochentag lässt sich am leichtesten für dich selbst reservieren Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel jour de la semaine est le plus facile à consacrer à toi-même Que feras-tu dans cette situation ?"},"a":{"ru":"Скажу правду сразу, даже если это будет неудобно.","en":"I’ll tell the truth immediately, even if it is uncomfortable.","es":"Diré la verdad de inmediato, aunque sea incómoda.","pt":"Vou dizer a verdade de imediato, mesmo que seja desconfortável.","de":"Ich sage sofort die Wahrheit, auch wenn sie unangenehm ist.","fr":"Je dirai la vérité tout de suite, même si elle est inconfortable."},"b":{"ru":"Сначала подберу спокойные слова, чтобы не ранить человека.","en":"I’ll choose calm words first so I don’t hurt the person.","es":"Primero elegiré palabras tranquilas para no herir a la otra persona.","pt":"Primeiro vou escolher palavras calmas para não magoar a pessoa.","de":"Ich wähle zuerst ruhige Worte, damit ich die Person nicht verletze.","fr":"Je choisirai d’abord des mots calmes pour ne pas blesser la personne."},"c":{"ru":"Скажу честно, но дам человеку время спокойно это осмыслить.","en":"I’ll be honest but give the person time to process it calmly.","es":"Seré sincero, pero dejaré que la persona lo procese con calma.","pt":"Vou ser honesto, mas darei tempo para a pessoa pensar com calma.","de":"Ich bin ehrlich, gebe der Person aber Zeit, darüber nachzudenken.","fr":"Je serai honnête, tout en laissant à la personne le temps de réfléchir calmement."},"stats":{"a":51,"b":31,"c":18},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что тебе сложнее всего отключить во время отдыха Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What is hardest for you to switch off while resting What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué es lo más difícil de desconectar durante el descanso ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que é mais difícil desligar durante o descanso O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was kannst du während der Erholung am schwersten abschalten Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Qu’est-ce qui est le plus difficile à couper pendant le repos Que feras-tu dans cette situation ?"},"a":{"ru":"Скажу правду сразу, даже если это будет неудобно.","en":"I’ll tell the truth immediately, even if it is uncomfortable.","es":"Diré la verdad de inmediato, aunque sea incómoda.","pt":"Vou dizer a verdade de imediato, mesmo que seja desconfortável.","de":"Ich sage sofort die Wahrheit, auch wenn sie unangenehm ist.","fr":"Je dirai la vérité tout de suite, même si elle est inconfortable."},"b":{"ru":"Сначала подберу спокойные слова, чтобы не ранить человека.","en":"I’ll choose calm words first so I don’t hurt the person.","es":"Primero elegiré palabras tranquilas para no herir a la otra persona.","pt":"Primeiro vou escolher palavras calmas para não magoar a pessoa.","de":"Ich wähle zuerst ruhige Worte, damit ich die Person nicht verletze.","fr":"Je choisirai d’abord des mots calmes pour ne pas blesser la personne."},"c":{"ru":"Скажу честно, но дам человеку время спокойно это осмыслить.","en":"I’ll be honest but give the person time to process it calmly.","es":"Seré sincero, pero dejaré que la persona lo procese con calma.","pt":"Vou ser honesto, mas darei tempo para a pessoa pensar com calma.","de":"Ich bin ehrlich, gebe der Person aber Zeit, darüber nachzudenken.","fr":"Je serai honnête, tout en laissant à la personne le temps de réfléchir calmement."},"stats":{"a":52,"b":42,"c":6},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой вид отдыха тебе нравится пробовать впервые Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which type of leisure would you like to try for the first time What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué tipo de ocio te gustaría probar por primera vez ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que tipo de lazer gostaria de experimentar pela primeira vez O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welche Freizeitaktivität würdest du zum ersten Mal ausprobieren Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel loisir aimerais-tu essayer pour la première fois Que feras-tu dans cette situation ?"},"a":{"ru":"Скажу правду сразу, даже если это будет неудобно.","en":"I’ll tell the truth immediately, even if it is uncomfortable.","es":"Diré la verdad de inmediato, aunque sea incómoda.","pt":"Vou dizer a verdade de imediato, mesmo que seja desconfortável.","de":"Ich sage sofort die Wahrheit, auch wenn sie unangenehm ist.","fr":"Je dirai la vérité tout de suite, même si elle est inconfortable."},"b":{"ru":"Сначала подберу спокойные слова, чтобы не ранить человека.","en":"I’ll choose calm words first so I don’t hurt the person.","es":"Primero elegiré palabras tranquilas para no herir a la otra persona.","pt":"Primeiro vou escolher palavras calmas para não magoar a pessoa.","de":"Ich wähle zuerst ruhige Worte, damit ich die Person nicht verletze.","fr":"Je choisirai d’abord des mots calmes pour ne pas blesser la personne."},"c":{"ru":"Скажу честно, но дам человеку время спокойно это осмыслить.","en":"I’ll be honest but give the person time to process it calmly.","es":"Seré sincero, pero dejaré que la persona lo procese con calma.","pt":"Vou ser honesto, mas darei tempo para a pessoa pensar com calma.","de":"Ich bin ehrlich, gebe der Person aber Zeit, darüber nachzudenken.","fr":"Je serai honnête, tout en laissant à la personne le temps de réfléchir calmement."},"stats":{"a":38,"b":28,"c":34},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какое воспоминание ты бы сохранил на отдельной фотографии Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which memory would you keep in a separate photograph What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué recuerdo guardarías en una fotografía aparte ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que lembrança guardaria em uma fotografia separada O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welche Erinnerung würdest du auf einem eigenen Foto festhalten Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel souvenir garderais-tu sur une photo à part Que feras-tu dans cette situation ?"},"a":{"ru":"Поставлю ближайшую цель и сразу начну с первого шага.","en":"I’ll set a near-term goal and start with the first step immediately.","es":"Fijaré un objetivo cercano y empezaré de inmediato por el primer paso.","pt":"Vou definir um objetivo próximo e começar logo pelo primeiro passo.","de":"Ich setze ein kurzfristiges Ziel und beginne sofort mit dem ersten Schritt.","fr":"Je fixerai un objectif proche et commencerai immédiatement par la première étape."},"b":{"ru":"Разобью задачу на части и пойду по плану.","en":"I’ll break the task into parts and follow a plan.","es":"Dividiré la tarea en partes y seguiré un plan.","pt":"Vou dividir a tarefa em partes e seguir um plano.","de":"Ich teile die Aufgabe in Teile und arbeite nach einem Plan.","fr":"Je diviserai la tâche en étapes et suivrai un plan."},"c":{"ru":"Сначала найду более простой путь и сравню его с исходным.","en":"I’ll look for a simpler path first and compare it with the original.","es":"Primero buscaré un camino más sencillo y lo compararé con el original.","pt":"Primeiro procurarei um caminho mais simples e compará-lo-ei com o original.","de":"Ich suche zuerst einen einfacheren Weg und vergleiche ihn mit dem ursprünglichen.","fr":"Je chercherai d’abord une voie plus simple et la comparerai à l’originale."},"stats":{"a":45,"b":39,"c":16},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой старый предмет способен мгновенно вернуть прошлое Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which old object can instantly bring the past back to you What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué objeto antiguo puede devolverte el pasado al instante ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que objeto antigo pode trazer o passado de volta instantaneamente O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welcher alte Gegenstand kann die Vergangenheit sofort zurückbringen Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel vieil objet peut te ramener instantanément dans le passé Que feras-tu dans cette situation ?"},"a":{"ru":"Поставлю ближайшую цель и сразу начну с первого шага.","en":"I’ll set a near-term goal and start with the first step immediately.","es":"Fijaré un objetivo cercano y empezaré de inmediato por el primer paso.","pt":"Vou definir um objetivo próximo e começar logo pelo primeiro passo.","de":"Ich setze ein kurzfristiges Ziel und beginne sofort mit dem ersten Schritt.","fr":"Je fixerai un objectif proche et commencerai immédiatement par la première étape."},"b":{"ru":"Разобью задачу на части и пойду по плану.","en":"I’ll break the task into parts and follow a plan.","es":"Dividiré la tarea en partes y seguiré un plan.","pt":"Vou dividir a tarefa em partes e seguir um plano.","de":"Ich teile die Aufgabe in Teile und arbeite nach einem Plan.","fr":"Je diviserai la tâche en étapes et suivrai un plan."},"c":{"ru":"Сначала найду более простой путь и сравню его с исходным.","en":"I’ll look for a simpler path first and compare it with the original.","es":"Primero buscaré un camino más sencillo y lo compararé con el original.","pt":"Primeiro procurarei um caminho mais simples e compará-lo-ei com o original.","de":"Ich suche zuerst einen einfacheren Weg und vergleiche ihn mit dem ursprünglichen.","fr":"Je chercherai d’abord une voie plus simple et la comparerai à l’originale."},"stats":{"a":52,"b":25,"c":23},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что ты обычно чувствуешь, пересматривая детские снимки Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What do you usually feel when looking through childhood photos What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué sientes normalmente al volver a ver fotos de tu infancia ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que costuma sentir ao rever fotos da infância O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was fühlst du normalerweise, wenn du Kinderfotos ansiehst Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Que ressens-tu généralement en regardant des photos de ton enfance Que feras-tu dans cette situation ?"},"a":{"ru":"Поставлю ближайшую цель и сразу начну с первого шага.","en":"I’ll set a near-term goal and start with the first step immediately.","es":"Fijaré un objetivo cercano y empezaré de inmediato por el primer paso.","pt":"Vou definir um objetivo próximo e começar logo pelo primeiro passo.","de":"Ich setze ein kurzfristiges Ziel und beginne sofort mit dem ersten Schritt.","fr":"Je fixerai un objectif proche et commencerai immédiatement par la première étape."},"b":{"ru":"Разобью задачу на части и пойду по плану.","en":"I’ll break the task into parts and follow a plan.","es":"Dividiré la tarea en partes y seguiré un plan.","pt":"Vou dividir a tarefa em partes e seguir um plano.","de":"Ich teile die Aufgabe in Teile und arbeite nach einem Plan.","fr":"Je diviserai la tâche en étapes et suivrai un plan."},"c":{"ru":"Сначала найду более простой путь и сравню его с исходным.","en":"I’ll look for a simpler path first and compare it with the original.","es":"Primero buscaré un camino más sencillo y lo compararé con el original.","pt":"Primeiro procurarei um caminho mais simples e compará-lo-ei com o original.","de":"Ich suche zuerst einen einfacheren Weg und vergleiche ihn mit dem ursprünglichen.","fr":"Je chercherai d’abord une voie plus simple et la comparerai à l’originale."},"stats":{"a":53,"b":36,"c":11},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какую историю из прошлого ты хотел бы услышать от родственников Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which story from the past would you like to hear from your relatives What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué historia del pasado te gustaría escuchar de tus familiares ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que história do passado gostaria de ouvir dos seus familiares O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welche Geschichte aus der Vergangenheit würdest du gern von deinen Verwandten hören Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quelle histoire du passé aimerais-tu entendre de tes proches Que feras-tu dans cette situation ?"},"a":{"ru":"Поставлю ближайшую цель и сразу начну с первого шага.","en":"I’ll set a near-term goal and start with the first step immediately.","es":"Fijaré un objetivo cercano y empezaré de inmediato por el primer paso.","pt":"Vou definir um objetivo próximo e começar logo pelo primeiro passo.","de":"Ich setze ein kurzfristiges Ziel und beginne sofort mit dem ersten Schritt.","fr":"Je fixerai un objectif proche et commencerai immédiatement par la première étape."},"b":{"ru":"Разобью задачу на части и пойду по плану.","en":"I’ll break the task into parts and follow a plan.","es":"Dividiré la tarea en partes y seguiré un plan.","pt":"Vou dividir a tarefa em partes e seguir um plano.","de":"Ich teile die Aufgabe in Teile und arbeite nach einem Plan.","fr":"Je diviserai la tâche en étapes et suivrai un plan."},"c":{"ru":"Сначала найду более простой путь и сравню его с исходным.","en":"I’ll look for a simpler path first and compare it with the original.","es":"Primero buscaré un camino más sencillo y lo compararé con el original.","pt":"Primeiro procurarei um caminho mais simples e compará-lo-ei com o original.","de":"Ich suche zuerst einen einfacheren Weg und vergleiche ihn mit dem ursprünglichen.","fr":"Je chercherai d’abord une voie plus simple et la comparerai à l’originale."},"stats":{"a":39,"b":47,"c":14},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что для тебя важнее в памятных вещах: предмет или история Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What matters more to you in a keepsake: the object or the story What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué es más importante en un recuerdo: el objeto o la historia ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que é mais importante em uma lembrança: o objeto ou a história O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was ist dir bei Erinnerungsstücken wichtiger: der Gegenstand oder die Geschichte Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Qu’est-ce qui compte le plus dans un souvenir : l’objet ou l’histoire Que feras-tu dans cette situation ?"},"a":{"ru":"Поставлю ближайшую цель и сразу начну с первого шага.","en":"I’ll set a near-term goal and start with the first step immediately.","es":"Fijaré un objetivo cercano y empezaré de inmediato por el primer paso.","pt":"Vou definir um objetivo próximo e começar logo pelo primeiro passo.","de":"Ich setze ein kurzfristiges Ziel und beginne sofort mit dem ersten Schritt.","fr":"Je fixerai un objectif proche et commencerai immédiatement par la première étape."},"b":{"ru":"Разобью задачу на части и пойду по плану.","en":"I’ll break the task into parts and follow a plan.","es":"Dividiré la tarea en partes y seguiré un plan.","pt":"Vou dividir a tarefa em partes e seguir um plano.","de":"Ich teile die Aufgabe in Teile und arbeite nach einem Plan.","fr":"Je diviserai la tâche en étapes et suivrai un plan."},"c":{"ru":"Сначала найду более простой путь и сравню его с исходным.","en":"I’ll look for a simpler path first and compare it with the original.","es":"Primero buscaré un camino más sencillo y lo compararé con el original.","pt":"Primeiro procurarei um caminho mais simples e compará-lo-ei com o original.","de":"Ich suche zuerst einen einfacheren Weg und vergleiche ihn mit dem ursprünglichen.","fr":"Je chercherai d’abord une voie plus simple et la comparerai à l’originale."},"stats":{"a":46,"b":33,"c":21},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что ты поставишь выше: честность, спокойствие или свободу Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which would you place higher: honesty, calm, or freedom What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué pondrías por encima: honestidad, calma o libertad ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que colocaria acima: honestidade, calma ou liberdade O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was würdest du höher stellen: Ehrlichkeit, Ruhe oder Freiheit Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Que placerais-tu plus haut : l’honnêteté, le calme ou la liberté Que feras-tu dans cette situation ?"},"a":{"ru":"Поставлю ближайшую цель и сразу начну с первого шага.","en":"I’ll set a near-term goal and start with the first step immediately.","es":"Fijaré un objetivo cercano y empezaré de inmediato por el primer paso.","pt":"Vou definir um objetivo próximo e começar logo pelo primeiro passo.","de":"Ich setze ein kurzfristiges Ziel und beginne sofort mit dem ersten Schritt.","fr":"Je fixerai un objectif proche et commencerai immédiatement par la première étape."},"b":{"ru":"Разобью задачу на части и пойду по плану.","en":"I’ll break the task into parts and follow a plan.","es":"Dividiré la tarea en partes y seguiré un plan.","pt":"Vou dividir a tarefa em partes e seguir um plano.","de":"Ich teile die Aufgabe in Teile und arbeite nach einem Plan.","fr":"Je diviserai la tâche en étapes et suivrai un plan."},"c":{"ru":"Сначала найду более простой путь и сравню его с исходным.","en":"I’ll look for a simpler path first and compare it with the original.","es":"Primero buscaré un camino más sencillo y lo compararé con el original.","pt":"Primeiro procurarei um caminho mais simples e compará-lo-ei com o original.","de":"Ich suche zuerst einen einfacheren Weg und vergleiche ihn mit dem ursprünglichen.","fr":"Je chercherai d’abord une voie plus simple et la comparerai à l’originale."},"stats":{"a":47,"b":44,"c":9},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какой поступок сильнее всего показывает характер человека Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which action reveals a person’s character most strongly What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué acción muestra mejor el carácter de una persona ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que atitude mostra mais fortemente o caráter de uma pessoa O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welche Handlung zeigt den Charakter eines Menschen am deutlichsten Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quel geste montre le mieux le caractère d’une personne Que feras-tu dans cette situation ?"},"a":{"ru":"Поставлю ближайшую цель и сразу начну с первого шага.","en":"I’ll set a near-term goal and start with the first step immediately.","es":"Fijaré un objetivo cercano y empezaré de inmediato por el primer paso.","pt":"Vou definir um objetivo próximo e começar logo pelo primeiro passo.","de":"Ich setze ein kurzfristiges Ziel und beginne sofort mit dem ersten Schritt.","fr":"Je fixerai un objectif proche et commencerai immédiatement par la première étape."},"b":{"ru":"Разобью задачу на части и пойду по плану.","en":"I’ll break the task into parts and follow a plan.","es":"Dividiré la tarea en partes y seguiré un plan.","pt":"Vou dividir a tarefa em partes e seguir um plano.","de":"Ich teile die Aufgabe in Teile und arbeite nach einem Plan.","fr":"Je diviserai la tâche en étapes et suivrai un plan."},"c":{"ru":"Сначала найду более простой путь и сравню его с исходным.","en":"I’ll look for a simpler path first and compare it with the original.","es":"Primero buscaré un camino más sencillo y lo compararé con el original.","pt":"Primeiro procurarei um caminho mais simples e compará-lo-ei com o original.","de":"Ich suche zuerst einen einfacheren Weg und vergleiche ihn mit dem ursprünglichen.","fr":"Je chercherai d’abord une voie plus simple et la comparerai à l’originale."},"stats":{"a":54,"b":30,"c":16},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что труднее изменить в себе: привычку, мнение или обещание Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. What is harder to change in yourself: a habit, an opinion, or a promise What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué es más difícil cambiar en ti: un hábito, una opinión o una promesa ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. O que é mais difícil mudar em si mesmo: um hábito, uma opinião ou uma promessa O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was ist schwerer an dir zu ändern: eine Gewohnheit, eine Meinung oder ein Versprechen Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Qu’est-ce qui est le plus difficile à changer en toi : une habitude, une opinion ou une promesse Que feras-tu dans cette situation ?"},"a":{"ru":"Поставлю ближайшую цель и сразу начну с первого шага.","en":"I’ll set a near-term goal and start with the first step immediately.","es":"Fijaré un objetivo cercano y empezaré de inmediato por el primer paso.","pt":"Vou definir um objetivo próximo e começar logo pelo primeiro passo.","de":"Ich setze ein kurzfristiges Ziel und beginne sofort mit dem ersten Schritt.","fr":"Je fixerai un objectif proche et commencerai immédiatement par la première étape."},"b":{"ru":"Разобью задачу на части и пойду по плану.","en":"I’ll break the task into parts and follow a plan.","es":"Dividiré la tarea en partes y seguiré un plan.","pt":"Vou dividir a tarefa em partes e seguir um plano.","de":"Ich teile die Aufgabe in Teile und arbeite nach einem Plan.","fr":"Je diviserai la tâche en étapes et suivrai un plan."},"c":{"ru":"Сначала найду более простой путь и сравню его с исходным.","en":"I’ll look for a simpler path first and compare it with the original.","es":"Primero buscaré un camino más sencillo y lo compararé con el original.","pt":"Primeiro procurarei um caminho mais simples e compará-lo-ei com o original.","de":"Ich suche zuerst einen einfacheren Weg und vergleiche ihn mit dem ursprünglichen.","fr":"Je chercherai d’abord une voie plus simple et la comparerai à l’originale."},"stats":{"a":40,"b":41,"c":19},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Какое качество ты хотел бы усилить в ближайший год Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. Which quality would you like to strengthen in the coming year What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. ¿Qué cualidad te gustaría fortalecer durante el próximo año ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Que qualidade gostaria de fortalecer no próximo ano O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Welche Eigenschaft möchtest du im kommenden Jahr stärken Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Quelle qualité aimerais-tu renforcer au cours de l’année prochaine Que feras-tu dans cette situation ?"},"a":{"ru":"Поставлю ближайшую цель и сразу начну с первого шага.","en":"I’ll set a near-term goal and start with the first step immediately.","es":"Fijaré un objetivo cercano y empezaré de inmediato por el primer paso.","pt":"Vou definir um objetivo próximo e começar logo pelo primeiro passo.","de":"Ich setze ein kurzfristiges Ziel und beginne sofort mit dem ersten Schritt.","fr":"Je fixerai un objectif proche et commencerai immédiatement par la première étape."},"b":{"ru":"Разобью задачу на части и пойду по плану.","en":"I’ll break the task into parts and follow a plan.","es":"Dividiré la tarea en partes y seguiré un plan.","pt":"Vou dividir a tarefa em partes e seguir um plano.","de":"Ich teile die Aufgabe in Teile und arbeite nach einem Plan.","fr":"Je diviserai la tâche en étapes et suivrai un plan."},"c":{"ru":"Сначала найду более простой путь и сравню его с исходным.","en":"I’ll look for a simpler path first and compare it with the original.","es":"Primero buscaré un camino más sencillo y lo compararé con el original.","pt":"Primeiro procurarei um caminho mais simples e compará-lo-ei com o original.","de":"Ich suche zuerst einen einfacheren Weg und vergleiche ihn mit dem ursprünglichen.","fr":"Je chercherai d’abord une voie plus simple et la comparerai à l’originale."},"stats":{"a":47,"b":27,"c":26},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}},{"question":{"ru":"Представь, что это происходит с тобой прямо сейчас. Что, по-твоему, делает выбор действительно зрелым Что ты сделаешь в этой ситуации?","en":"Imagine this is happening to you right now. In your opinion, what makes a choice truly mature What will you do in this situation?","es":"Imagina que esto te está pasando ahora mismo. En tu opinión, ¿qué hace que una elección sea realmente madura ¿Qué harás en esta situación?","pt":"Imagina que isto está a acontecer contigo agora. Na sua opinião, o que torna uma escolha realmente madura O que farás nesta situação?","de":"Stell dir vor, dass dir das gerade jetzt passiert. Was macht eine Entscheidung deiner Meinung nach wirklich reif Was wirst du in dieser Situation tun?","fr":"Imagine que cela t’arrive en ce moment. Selon toi, qu’est-ce qui rend un choix vraiment mûr Que feras-tu dans cette situation ?"},"a":{"ru":"Поставлю ближайшую цель и сразу начну с первого шага.","en":"I’ll set a near-term goal and start with the first step immediately.","es":"Fijaré un objetivo cercano y empezaré de inmediato por el primer paso.","pt":"Vou definir um objetivo próximo e começar logo pelo primeiro passo.","de":"Ich setze ein kurzfristiges Ziel und beginne sofort mit dem ersten Schritt.","fr":"Je fixerai un objectif proche et commencerai immédiatement par la première étape."},"b":{"ru":"Разобью задачу на части и пойду по плану.","en":"I’ll break the task into parts and follow a plan.","es":"Dividiré la tarea en partes y seguiré un plan.","pt":"Vou dividir a tarefa em partes e seguir um plano.","de":"Ich teile die Aufgabe in Teile und arbeite nach einem Plan.","fr":"Je diviserai la tâche en étapes et suivrai un plan."},"c":{"ru":"Сначала найду более простой путь и сравню его с исходным.","en":"I’ll look for a simpler path first and compare it with the original.","es":"Primero buscaré un camino más sencillo y lo compararé con el original.","pt":"Primeiro procurarei um caminho mais simples e compará-lo-ei com o original.","de":"Ich suche zuerst einen einfacheren Weg und vergleiche ihn mit dem ursprünglichen.","fr":"Je chercherai d’abord une voie plus simple et la comparerai à l’originale."},"stats":{"a":48,"b":38,"c":14},"analysis":{"ru":"","en":"","es":"","pt":"","de":"","fr":""}}];
...
/* ===== v4.1.30 — Chronicles flow + universal interaction hardening ===== */
(function(){
  // The latest renderer owns Chronicles navigation. Never route a completed run
  // through the legacy final screen, which used to leave "Show results" inert.
  window.openFateDilemmas = function(){
    try{
      const raw = localStorage.getItem('fate_dilemmas');
      const state = raw ? JSON.parse(raw) : {currentIndex:0, answers:[]};
      if(!Array.isArray(state.answers)) state.answers=[];
      if(!Number.isFinite(Number(state.currentIndex))) state.currentIndex=0;
      if(state.currentIndex >= FATE_DILEMMAS.length){
        const overlay=document.getElementById('fate-overlay');
        if(overlay) finalFateResult(overlay);
        return;
      }
      window.renderFateQuestion(Number(state.currentIndex));
    }catch(err){
      console.error('Chronicles open error:',err);
    }
  };
  ...
  window.nextFateQuestion = function(){
    try{
      ...
      console.error('Chronicles next error:',err);
    }
  };

  // Give critical result/restart controls both an inline-safe path and a delegated path.
  // This prevents a renderer replacement from accidentally dropping the click handler.
  const bindCritical = ()=>{
    const show=document.getElementById('fate-show-results');
    if(show){
      show.type='button';
      show.onclick=()=>window.showChronicleResults();
      show.setAttribute('aria-label', show.textContent || 'Show results');
    }
    const restart=document.getElementById('fate-restart-result');
    if(restart){
      restart.type='button';
      restart.onclick=()=>window.restartFateDilemmas?.();
    }
  };
  const originalShow=window.showChronicleResults;
  window.showChronicleResults=function(){
    if(typeof originalShow==='function') originalShow();
    bindCritical();
  };

  // Any dynamically inserted button gets the same baseline interaction guarantees.
  function harden(root){
    const scope=root||document;
    scope.querySelectorAll?.('button').forEach(btn=>{
      if(!btn.getAttribute('type')) btn.setAttribute('type','button');
      btn.style.touchAction='manipulation';
      if(btn.classList.contains('fate-btn') || btn.classList.contains('fate-next') || btn.classList.contains('fate-channel-btn')){
        btn.style.pointerEvents='auto';
      }
    });
    bindCritical();
